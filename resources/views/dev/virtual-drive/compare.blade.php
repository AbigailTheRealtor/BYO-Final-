...
<div class="vd-compare" id="vd-compare"
     ...
     data-apple-url="{{ route('dev.virtual-drive.apple', [], false) }}"
     data-google-url="{{ route('dev.virtual-drive.google', [], false) }}"
    ...
    <header class="vd-topbar">
        ...
        <nav class="vd-provider-nav" aria-label="Street-level provider">
            <a href="{{ route('dev.virtual-drive.apple', [], false) }}">Apple Look Around</a>
            <a href="{{ route('dev.virtual-drive.google', [], false) }}">Google Street View</a>
        </nav>
    </header>
    ...
    <main class="vd-compare-main">
        ...
        <p class="vd-compare-lede">
            <a class="vd-compare-link" href="{{ route('dev.virtual-drive.google', ['view' => 'customer', 'listing' => $defaultListingKey], false) }}">Customer preview — start on Manasota Key Road</a>
...
<script src="/js/virtual-drive/virtual-drive-compare.js"></script>
