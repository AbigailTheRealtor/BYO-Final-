...
@if ($interested_lease_option === 'Yes')
    ...
    <div class="form-group mb-4">
        <label class="fw-bold d-flex align-items-center">
            ...
            @else
                <span class="ms-2" data-bs-toggle="tooltip" data-bs-html="true"
                    title="Choose how the Buyer’s Broker will be compensated if a property is leased. Options include a flat fee, a percentage of the net aggregate rent, a combination of flat fee and percentage, or select “Other” to define a custom structure. Then enter the appropriate amount(s) based on your selection.">
                    <i class="fa-solid fa-circle-info"></i>
...
<div class="form-group mb-4">
    ...
    @if ($agency_agreement_timeframe === 'Other' || $agency_agreement_timeframe === 'custom')
        <div class="mt-3">
