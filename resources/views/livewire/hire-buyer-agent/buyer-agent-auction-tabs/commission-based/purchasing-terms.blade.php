...
<div class="form-group">
    ...
    <div class="input-cover" wire:ignore>
        ...
        <select id="sale_provision" class="form-control select2-multiple" data-placeholder="Select" multiple>
            <option value=""></option>
...
<div class="form-group mt-3">
    ...
    <div class="input-cover" id="offered_financing_wrapper" wire:ignore>
        ...
        <select id="offered_financing" class="form-control select2-multiple" data-placeholder="Select" multiple required>
            <option value=""></option>
