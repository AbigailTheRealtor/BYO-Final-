...
<h4>Property Preferences Buyer</h4>
<!-- Acceptable Cities -->

<div class="form-group mb-3">
    <label class="fw-bold mb-2">Acceptable Cities:<span class="text-danger">*</span></label>
...
<!-- Acceptable Counties -->
<div class="form-group mb-3">
    <label class="fw-bold mb-2">Acceptable Counties:<span class="text-danger">*</span></label>
    <div class="input-cover position-relative">
...
<div class="form-group">
    ...
    <div class="input-cover position-relative">
        <input type="text" wire:model="state" class="form-control has-icon" data-icon="fa-solid fa-flag-usa" required
            ...
            wire:keydown.enter.prevent="selectStateSuggestion" autocomplete="off" placeholder="Enter state" required>
...
<div class="form-group">
    <label class="fw-bold">Acceptable Property Type:<span class="text-danger">*</span></label>
...
<div class="form-group mt-3">
    <label class="fw-bold">Acceptable Property Style:<span class="text-danger">*</span></label>
    <div class="input-cover">
...
<div class="form-group other_bedrooms d-none">
    ...
    <div class="input-cover">
        <input type="number" wire:model="other_bedrooms" class="form-control has-icon" data-icon="fa-solid fa-bed"
            placeholder="Enter other bedrooms (e.g., 11) ">
    </div>
...
<div class="form-group">
    <label class="fw-bold">Minimum Bathrooms Needed:<span class="text-danger">*</span></label>
    <div class="input-cover">
...
<div class="form-group">
    ...
    <div class="input-cover">
        <input type="number" wire:model="minimum_heated_square" class="form-control has-icon"
            data-icon="fa-solid fa-ruler" placeholder="Enter heated square footage (e.g., 1,000)">
    </div>
...
<div class="form-group d-none" id="other_parking_space_wrapper">
    <label class="fw-bold">Specify Other Garage/Parking Features:</label>
    <div class="input-cover">

        <input type="text" wire:model="other_parking_space_wrapper" id="other_parking_space"
            class="form-control has-icon" data-icon="fa-solid fa-warehouse" placeholder="Enter garage/parking space">
    </div>
</div>
...
<!-- Other Preferences Input (Hidden by Default) -->
<div class="form-group" id="other_preferences" style="display: none;">
    {{-- <label class="fw-bold">Specify Other View Preference:</label> --}}
    <div class="input-cover">
        <input type="text" wire:model="other_preferences" class="form-control has-icon"
            data-icon="fa-solid fa-tree"
            placeholder="Enter any other included assets (e.g., inventory, customer lists)">
    </div>
...
@if ($property_type === 'Residential')
<div class="form-group">
    <label class="fw-bold">Eligibility/Interest in Leasing in 55-and-Over
        Communities:<span class="text-danger">*</span></label>
    <div class="input-cover">
...
<div class="form-group other_non_negotiable_amenities d-none">
    {{-- <label class="fw-bold">Non-Negotiable Amenities and Property Features:</label> --}}
    <div class="input-cover">
        <input type="text" wire:model="other_non_negotiable_amenities" class="form-control has-icon"
            data-icon="fa-solid fa-lock"
            placeholder="Enter other required amenities or property features (e.g., sauna, EV charger, outdoor kitchen) ">
    </div>
...
<div class="form-group">
    ...
    <div class="input-cover">
        <select wire:model="pets" id="pets" class="form-control has-icon"
            data-icon="fa-solid fa-paw" required>
            <option value="">Select</option>
            <option value="Yes">Yes</option>
            <option value="No">No</option>
        </select>
...
<div id="pet-details">
    <!-- Number of Pet(s) -->
    <div class="form-group">
        <label class="fw-bold">Number of Pet(s):</label>
        <div class="input-cover">
    ...
    <!-- Type of Pet(s) -->
    <div class="form-group">
        <label class="fw-bold">Type of Pet(s):</label>
        <div class="input-cover">
            <input type="text" wire:model="type_of_pets" class="form-control has-icon"
                data-icon="fa-solid fa-cat" placeholder="Enter type of pet(s) (e.g., dog, cat)">
        </div>
    ...
    <!-- Weight of Pet(s) -->
    <div class="form-group">
        <label class="fw-bold">Weight of Pet(s) (lbs):</label>
        <div class="input-cover">
            <input type="number" wire:model="weight_of_pets" class="form-control has-icon"
                data-icon="fa-solid fa-weight" placeholder="Enter weight of each pet (e.g., 45 lbs, 12 lbs)">
        </div>
...
<div class="form-group">
    ...
    <div class="input-cover">
        <select wire:model="real_estate_purchase" class="form-control has-icon"
            data-icon="fas fa-building" required>
            <option value="">Select</option>
...
@if ($property_type === 'Income' or $property_type === 'Commercial' or $property_type === 'Business')
<div class="form-group">
    <label class="fw-bold">Required Property or Business Assets:<span class="text-danger">*</span></label>
    <div class="input-cover">
        <select wire:model="assets" id="assets" class="form-control has-icon" data-icon="fas fa-building"
            required>
            <option value="">Select</option>
            <option value="Real Estate Building and Business">Real Estate Building and Business</option>
            <option value="Business Only">Business Only</option>
            <option value="Goodwill and Business Name">Goodwill and Business Name</option>
            <option value="Furniture, Fixtures, and Equipment (as per attached inventory)">Furniture, Fixtures, and
                Equipment (as per attached inventory)</option>
            ...
            <option value="Rights under any Agreement for Interests">Rights under any Agreement for Interests
            </option>
...
<div>
    <!-- Number of Pet(s) -->
    <div class="form-group">
        <label class="fw-bold">Enter minimum total number of units:</label>
        <div class="input-cover">
            <input type="text" wire:model="assets_other" class="form-control has-icon"
    ...
    <div class="form-group">
        ...
        <div class="input-cover">
            <input type="text" wire:model="property_criteria" class="form-control has-icon"
                data-icon="fas fa-building"
                placeholder="Please Enter the Buyer's Preferred Income Property Criteria">
        </div>
    </div>
</div>

<!-- Acceptable Unit Sizes -->
<div class="form-group">
    <label class="fw-bold">Acceptable Unit Sizes:</label>
    <div class="input-cover">
    ...
    <div class="form-group">
        ...
        <div class="input-cover">
            <input type="text" wire:model="unit_size_other" class="form-control has-icon"
                data-icon="fas fa-building" placeholder="Enter acceptable unit sizes (e.g., 5/2)">
        </div>
    </div>
</div>
@endif
...
<div class="form-group">
    ...
    <div class="input-cover">
        <select wire:model="number_of_unit" id="purchasing_props" class="form-control has-icon"
            data-icon="fa-solid fa-home">
            <option value="">Select</option>
    ...
    <div class="form-group">
        ...
        <div class="input-cover">
            <input type="number" wire:model="number_of_unit_other" class="form-control has-icon"
                data-icon="fa-solid fa-home" placeholder="Enter minimum total number of units (e.g., 4)">
        </div>
        <span class="error mt-2" id="number_of_unit_error"></span>
    </div>
</div>
    ...
    <div class="form-group">
        ...
        <div class="input-cover">
            <input type="number" wire:model="minimum_annual_net_income" class="form-control has-icon"
                data-icon="fa-solid fa-dollar-sign" placeholder="Enter minimum annual net income (e.g., 50,000)">
        </div>
        <span class="error mt-2" id="number_of_unit_error"></span>
    </div>
</div>
    ...
    <div class="form-group">
        ...
        <div class="input-cover">
            <input type="number" wire:model="minimum_cap_rate" class="form-control has-icon"
                data-icon="fa-solid fa-percent" placeholder="Enter minimum cap rate (e.g., 6.5)">
        </div>
        <span class="error mt-2" id="number_of_unit_error"></span>
    </div>
</div>
