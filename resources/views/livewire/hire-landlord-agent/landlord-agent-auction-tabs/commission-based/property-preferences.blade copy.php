...
<div class="alert alert-info bg-light-info border-info mb-4">
    <div class="d-flex align-items-center">
        <div>
            <strong>🏠 Describe the property being offered for rent — including location, size, style, layout, and key features.
            </strong>
        </div>
    </div>
</div>
...
<div class="form-group mt-3">
    ...
    <div class="input-cover">
        ...
        <select wire:model="property_items"  class="form-control has-icon"
            data-icon="fa-solid fa-home input-icon2" @if (!$property_type) disabled @endif
            required>
            <option value="">Select</option>
...
<div class="form-group">
    ...
    <span class="ms-2" data-bs-toggle="tooltip" data-bs-html="true"
        title="Select the current condition of the property being listed for rent.">
        <i class="fa-solid fa-circle-info"></i>
    </span>
...
@if ($property_type === 'Commercial Property')
    <div class="form-group">
        <label class="fw-bold"> Net Leasable SqFt:</label>
        <span class="ms-2" data-bs-toggle="tooltip" data-bs-html="true"
    ...
    <div class="form-group" id="other_appliances">
        <div class="input-cover">
            <input type="text" wire:model="other_appliances" class="form-control has-icon"
                data-icon="fa-solid fa-plug" placeholder="Enter other appliances (e.g., Air Fryer Oven, Induction Cooktop, Double Oven)"
...
@if ($property_type === 'Residential Property')
    <div class="form-group">
        <label class="fw-bold">Furnishings:<span class="text-danger">*</span></label>
...
<div class="form-group d-none" id="other_parking_space_wrapper">
    ...
    <div class="input-cover">
        <input type="text" wire:model="other_parking_space_wrapper" id="other_parking_space"
            class="form-control has-icon" data-icon="fa-solid fa-warehouse" placeholder="Enter other garage/parking features (e.g., Tandem Parking, Gated Entry, Shared Driveway)">
    </div>
</div>
@endif
...
<div class="form-group">
    ...
    <div class="input-cover">
        <select wire:ignore wire:model="view_preference" id="view_preference" class="form-control has-icon select2-multiple"
...
<div class="form-group" id="other_preferences" style="display: {{ $is_other_visible ? 'block' : 'none' }}">
    <div class="input-cover">
        <input type="text" wire:model="other_preferences" class="form-control has-icon"
            data-icon="fa-solid fa-tree" placeholder="Enter other view preference (e.g., lake, desert, courtyard)">
    </div>
...
<div
    ...
    <div class="input-cover">
        <input type="text" wire:model="other_non_negotiable_amenities" class="form-control has-icon"
           ...
           @if($property_type === 'Residential Property')
            placeholder="Enter other amenities or property features (e.g., Sauna, EV Charger, Outdoor Kitchen)"
        @elseif($property_type === 'Commercial Property')
            placeholder="Enter other amenities or property features (e.g., Rooftop Access, Backup Generator, Freight Elevator)"
        @endif>
...
@if ($property_type === 'Residential Property')
    <!-- Pets Allowed -->
    <div class="form-group">
        <label class="fw-bold">Pets Allowed:<span class="text-danger">*</span></label>
...
@if ($pets === 'Yes')
    <div id="pet-details">
        ...
        <!-- Maximum Weight -->
        <div class="form-group">
            <label class="fw-bold">Maximum Weight of Pets (lbs):</label>
            <div class="input-cover">
