<div class="dashboard-section">
        ...
        <div class="d-flex align-items-center">
            <div>
                <strong>📌 Provide the key details for this request, including the preferred Agent hire date and whether
                    the Tenant is currently represented by a Broker. </strong>
            </div>
        </div>
    </div>
    {{--
    ...
    <div class="form-group">
        <label class="fw-bold">Current Representation Status with Broker:<span class="text-danger">*</span>
            <span class="ms-2" data-bs-toggle="tooltip" data-bs-html="true"
                title="Indicate whether the Tenant is currently under a signed agreement with a Broker. “Represented” means the Tenant has signed a Tenant representation agreement; “Not Represented” means no agreement has been signed, and the Tenant is free to hire a Broker.">
                <i class="fa-solid fa-circle-info"></i> </span>
        </label>
        <div class="input-cover">
        ...
        <div id="representation_notice" class="alert alert-danger mt-2 d-none">
            This service is only available to Tenants who are not currently represented by a Broker.
        </div>
    </div>
    @if ($service_type === 'full_service')
        ...
        <div class="form-group">
            <label class="fw-bold">Desired Agent Hire Date:<span class="text-danger">*</span>
                <span class="ms-2" data-bs-toggle="tooltip" data-bs-html="true"
                    title="Select the date the Tenant needs to hire an Agent.">
                    <i class="fa-solid fa-circle-info"></i></span>
            </label>
            <div class="input-cover">
    ...
    <div class="form-group mt-3" @if ($auction_type !== 'Bidding Period') style="display: none;" @endif>
        ...
        <div class="input-cover">
            <select wire:model="auction_time" id="auction_time1" class="form-control has-icon"
                data-icon="fa-regular fa-clock" @if ($auction_type === 'Bidding Period')  @endif required>
                <option value="">Select</option>
    ...
    <div class="form-group mt-3" @if ($auction_type !== 'Traditional') style="display: none;" @endif>
        ...
        <div class="input-cover">
            <select wire:model="agent_bid_visibility" id="agent_bid_visibility" class="form-control has-icon"
                data-icon="fa-solid fa-eye" @if ($auction_type === 'Traditional') @endif required>
                <option value="">Select</option>
                <option value="Agent bids will be visible to other Agents">Agent bids will be visible to other Agents
                </option>
    ...
    <div class="form-group mt-3" @if ($auction_type !== 'Bidding Period') style="display: none;" @endif>
        ...
        <span class="ms-2" data-bs-toggle="tooltip" data-bs-html="true"
            title="Agents can submit bids until the countdown ends. All bid details—including the Broker Compensation, Agency Agreement Terms, and Services offered—are visible to competing Agents in real time, promoting transparency and competition. Once the timer ends, you may select the Agent who best meets your needs—you are not required to choose the highest bidder.">
            <i class="fa-solid fa-circle-info"></i> </span>
        <div class="input-cover">
