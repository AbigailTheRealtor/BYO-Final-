                    ...
                    <form wire:submit.prevent="update">
                        ...
                        @if ($service_type === 'full_service')
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                @foreach (['Listing Details', 'Property Preferences', 'Leasing Terms', 'Pre-Screening', 'Services', 'Additional Details', 'Broker Compensation', 'Tenant Information'] as $index => $tab)
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            @if ($service_type === 'full_service')
                                <div class="tab-pane fade {{ $activeTab === 1 ? 'show active' : '' }}"
                                    ...
                                    @include('livewire.tenant-agent-auction-tabs.commission-based.property-preferences')
                                ...
                                <div class="tab-pane fade {{ $activeTab === 3 ? 'show active' : '' }}"
                                    id="pre-screening" role="tabpanel" aria-labelledby="pre-screening-tab">
