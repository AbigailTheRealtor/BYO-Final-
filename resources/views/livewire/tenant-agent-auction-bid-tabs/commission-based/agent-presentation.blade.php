...
<div class="card mb-4 border-info">
    ...
    <div class="card-body">
        <p class="text-muted mb-3 small">Highlight your achievements, past tenant placements, and search wins — then share links to your website, reviews, and social media so clients can verify your reputation.</p>
        ...
        <div class="form-group mb-3">
            ...
            <textarea wire:model.defer="awards_recognition" class="form-control" rows="3"
                placeholder="e.g., Top Tenant Rep Agent 2023, Five-Star Agent on Zillow, Certified Relocation Specialist..."></textarea>
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <textarea wire:model.defer="sold_listed_examples" class="form-control" rows="3"
                placeholder="e.g., Helped a family relocate from NY — found a 3BR/2BA in Carrollwood at $2,200/mo with a month of free rent negotiated. Placed a couple in a South Tampa condo — under-asking rent with pet accommodation..."></textarea>
        </div>

        <!-- Search & Negotiation Wins -->
        <div class="form-group mb-4">
            ...
            <textarea wire:model.defer="marketing_success_examples" class="form-control" rows="3"
                placeholder="e.g., Negotiated first month free + reduced deposit for a relocating client. Used off-market network to find a pet-friendly home before it was publicly listed..."></textarea>
        </div>
