...
@if (isset($isListingCreatedByAgent) && $isListingCreatedByAgent)
<div class="form-group mb-4 mt-2">
    <hr>
    <h6 class="fw-bold mb-3">Referral &amp; Cooperation Terms</h6>
    <label class="fw-semibold" for="referral_fee_percent_seller_counter">Referral Fee (%) <span class="text-muted fw-normal">(Agent-to-Agent)</span></label>
    <input type="number"
           class="form-control mt-1"
           id="referral_fee_percent_seller_counter"
           wire:model.lazy="referral_fee_percent"
