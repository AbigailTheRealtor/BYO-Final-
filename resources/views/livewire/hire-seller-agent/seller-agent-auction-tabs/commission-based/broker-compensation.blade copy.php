        ...
        @elseif($purchase_fee_type === 'combo')
            <div class="row g-2">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        <span class="input-group-text"> $</span>
                        <input type="number" wire:model="purchase_fee_flat_combo" class="form-control"
...
<div class="form-group mb-4">
    ...
    <div class="input-cover mt-2">
        <select wire:model="commission_structure" class="form-control has-icon"
            ...
            {{-- <option value="No Compensation Offered to Buyer’s Broker">No Compensation Offered to Buyer’s Broker</option> --}}
            ...
            @elseif($purchase_fee_type === 'Percentage of the Total Purchase Price + Flat Fee')
                <div class="row g-2">
                    <div class="col-md-6">
                        <div class="input-group">
                            <input type="number" wire:model="purchase_fee_percentage_combo" class="form-control"
                                placeholder="Enter % of total purchase price (e.g., 3)">
                            <span class="input-group-text">%</span>
                        </div>
                    </div>
                    <div class="col-md-1 text-center pt-2">+</div>
...
@if ($interested_purchase_fee_type === 'Yes')
    ...
    <div class="form-group mb-4">
        ...
        <div class="input-cover mt-2">
            <select wire:model="purchase_fee_type" class="form-control has-icon"
                ...
                @elseif (in_array($property_type, ['Commercial', 'Business']))
                    ...
                    <option value="percentage_gross_lease">Percentage of Gross Rent </option>
                    </option>
                    <option value="Percentage of Month’s Rent">Percentage of Month’s Rent</option>
        ...
        <div class="mt-3">
            @if ($purchase_fee_type === 'Percentage of the Gross Lease Value')
                <div class="input-group">
...
<div class="input-group mt-2">
    ...
    <div class="input-group">
        ...
        <input type="number" wire:model="no_of_months" class="form-control"
            placeholder="Enter number of months (e.g., 1)">
    </div>
</div>
@elseif($purchase_fee_type === 'Percentage of Each Rental Period')
<div class="input-group">
    <input type="number" wire:model="seller_leasing_each_rental" class="form-control"
        placeholder="Enter percentage of each rental period (e.g., 10)">
    <span class="input-group-text">%</span>
</div>
@elseif($purchase_fee_type === 'Flat Fee + Percentage of the Gross Lease Value')
<div class="row g-2">
...
@elseif($purchase_fee_type === 'Flat Fee + Percentage of the Net Aggregate Rent')
<div class="row g-2">
...
@elseif ($purchase_fee_type === 'percentage_gross_lease')
<div class="mb-3">

    <label class="fw-bold mt-2">Sales Tax Selection:</label>
    <div class="input-cover mt-2">

        <select wire:model="sales_tax_option_gross" class="form-control has-icon" data-icon="fa-solid fa-ruler">
            <option value="">Select</option>
            <option value="including">Including Sales Tax</option>
            <option value="excluding">Excluding Sales Tax</option>
        </select>
...
<div class="mb-3">
    ...
    <div class="input-group">
        <input type="number" wire:model="gross_percentage_rent" class="form-control"
...
@elseif($purchase_fee_type === 'Percentage of Net Aggregate Rent')
<div class="input-group">

    <input type="text" wire:model="purchase_fee_other" class="form-control"
...
<div class="form-group mb-4">
    ...
    <div class="input-cover mt-2">
        <select wire:model="interested_lease_option" class="form-control has-icon"
            data-icon="fa-solid fa-file-invoice-dollar">
            <option value="">Select</option>
            <option value="Yes">Yes</option>
            <option value="No">No</option>
...
@if ($interested_lease_option === 'Yes')
    ...
    <div id="tab1" class="tab-content">
        ...
        <div class="form-group mt-2">
            ...
            <div class="input-group">
                <!-- Select for type -->
                <select wire:model="lease_type" class="form-select" style="max-width: 100px;">
    ...
    <div id="tab2" class="tab-content">
        ...
        <div class="form-group mt-2">
            ...
            <div class="input-group">
                <!-- Select for type -->
                <select wire:model="purchase_type" class="form-select" style="max-width: 100px;">
                    <option value="percent">%</option>
                    <option value="flat">$</option>
                </select>
...
<div class="form-group mb-4">
    <label class="fw-bold d-flex align-items-center">
     ...
     <div class="input-cover mt-2">
        <select wire:model="brokerage_relationship" class="form-control has-icon" data-icon="fa-solid fa-handshake">
            <option value="">Select</option>
            <option value="transaction_broker">Transaction Broker Representation</option>
            <option value="single_agent">Single Agent Representation</option>
            <option value="dual_agency">Dual Agency Representation</option>
            <option value="no_relationship">No Brokerage Relationship</option>
        </select>
    </div>
    ...
    @if ($brokerage_relationship)
        <div class="mt-3 p-3 bg-light rounded">
               ...
               @if ($brokerage_relationship === 'transaction_broker')
            ...
            @elseif ($brokerage_relationship === 'single_agent')
                ...
                <ul class="mb-2 ps-3">
                    ...
                    <li>Requires written consent from both the Seller and the Tenant.</li>
                    <li>Requires a Single Agent Notice signed by the Seller.</li>
                </ul>
            @elseif ($brokerage_relationship === 'dual_agency')
                <h6 class="fw-bold">• Dual Agency Representation:</h6>
                <ul class="mb-2 ps-3">
                    <li>The Broker represents both the Seller and the Tenant in the same transaction.</li>
            ...
            @elseif ($brokerage_relationship === 'no_relationship')
            ...
            @endif
            <div class="alert alert-warning mt-3 p-2 small">
                <strong>⚠️ Legal Notice:</strong> Certain brokerage relationships are not permitted in all states. If your selection is not allowed, the Broker will establish a permitted legal alternative. Real estate laws change frequently. Both the Broker and Seller are responsible for complying with all current local, state, and federal laws.
            </div>
        </div>
    @endif
</div>
