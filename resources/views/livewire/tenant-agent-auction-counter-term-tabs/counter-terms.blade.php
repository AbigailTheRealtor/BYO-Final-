...
<div class="card mb-4">
    ...
    <div class="card-body">
        <div class="form-group mb-0">
            ...
            <textarea class="form-control" wire:model="areas_of_interest" placeholder="e.g. Downtown, Midtown, Suburb areas" rows="3" @if($isOfferListing) required @endif style="min-height:80px;"></textarea>
