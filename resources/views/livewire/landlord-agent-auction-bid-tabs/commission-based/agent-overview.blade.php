    ...
    <div class="mt-4 p-3 border rounded bg-light">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
            <div>
                ...
                <p class="mb-0 small text-muted">Save your Agent Overview answers to pre-fill future bids for this listing type (Landlord — {{ ucfirst($property_type ?: 'residential') }}).</p>
            </div>
