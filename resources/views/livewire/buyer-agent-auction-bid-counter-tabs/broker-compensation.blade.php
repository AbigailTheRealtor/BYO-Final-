...
<div class="form-group mb-4 mt-2">
    ...
    <label class="fw-semibold" for="referral_fee_percent_buyer_counter">Referral Fee (%) <span class="text-muted fw-normal">(Agent-to-Agent)</span></label>
    <input type="number"
           class="form-control mt-1"
           id="referral_fee_percent_buyer_counter"
