...
<div class="mt-4 p-3 border rounded bg-light">
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div>
            ...
            <p class="mb-0 small text-muted">Save your Agent Overview, contact info, and presentation details to pre-fill future Buyer bids ({{ ucfirst($property_type ?: 'residential') }} property type).</p>
        </div>
        <div class="d-flex flex-wrap gap-2">
            ...
            <button type="button" wire:click="saveAsRoleDefault" class="btn btn-outline-secondary btn-sm">
                <i class="fa-solid fa-star me-1"></i> Save as Buyer Default
            </button>
        </div>
    </div>
    <p class="mb-0 mt-1 small text-muted"><i class="fa-solid fa-circle-info me-1"></i> "Save for {{ ucfirst($property_type ?: 'Residential') }}" overrides for this property type only. "Save as Buyer Default" applies to all property types without a specific override.</p>
</div>