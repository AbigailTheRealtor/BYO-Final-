...
<div class="alert alert-info bg-light-info border-info mb-4">
    <div class="d-flex align-items-center">
        <div>
            <strong>Provide tax, legal, flood zone, CDD/assessment, and HOA details so Agents and Tenants have the full picture of ongoing obligations and restrictions. Documents &amp; Disclosures are collected on the next tab.</strong>
        </div>
    </div>
</div>
...
<div class="card border mb-4">
    ...
    <div class="card-body">
        ...
        @if ($has_hoa === 'Yes')
            ...
            <div class="col-12" id="association_type_other_wrapper" style="display: {{ $association_type === 'Other' ? 'block' : 'none' }}">
            ...
            <div class="form-group mt-3">
                ...
                @endphp
                <div class="input-cover has-select-icon" wire:ignore>
                    <select id="association_amenities" class="form-control has-icon select2-multiple" data-icon="fa-solid fa-star" data-placeholder="Select" multiple>
