...
@if ($property_type === 'Commercial Property')
    ...
    <!-- Tenant's Broker Commission Structure (Commercial) -->
    <div class="form-group mb-4">
        <label class="fw-bold d-flex align-items-center">
            Tenant's Broker Commission Structure:
            <span class="ms-2" data-bs-toggle="tooltip" data-bs-html="true"
        ...
        <div class="mt-3">
            @if (
                ...
                <div class="mb-3">
                    <label class="form-label">Tenant's Broker Commission Fee:
                        <span class="ms-2" data-bs-toggle="tooltip" data-bs-html="true"
                            title="Enter the amount offered to the Tenant's Broker if a lease is secured. This can be a percentage of the net aggregate rent, a percentage of the gross rent, a flat fee, or a custom amount if &quot;Other&quot; is selected.">
                            <i class="fa-solid fa-circle-info"></i>
                        </span>
                    </label>
                    <div class="input-cover mt-2">
                ...
                @if ($tenant_broker_fee_structure === 'Percentage of the Net Aggregate Rent')
                    <div class="mb-3">
                        <div class="input-group">
                            <input type="number" wire:model.lazy="tenant_broker_percentage" class="form-control"
                ...
                @elseif ($tenant_broker_fee_structure === 'Percentage of the Gross Rent')
                    <div class="mb-3">
                        <div class="input-group">
                            <input type="number" wire:model.lazy="tenant_broker_gross_lease" class="form-control"
                    ...
                    <div class="mb-3">
                        <div class="input-group">
                            ...
                            <input type="text" wire:model.lazy="tenant_broker_flat_fee" class="form-control"
                                ...
                                data-error-id="tenant_broker_flat_fee_commercial_error" oninput="validateInput(this)"
                                onblur="reformatNumber(this)" onpaste="handlePaste(event)">
                        </div>
                        <span class="error mt-2" id="tenant_broker_flat_fee_commercial_error"></span>
                    </div>
                @elseif ($tenant_broker_fee_structure === 'Other')
                    <div class="mb-3">
                        <div class="input-group">
                            <input type="text" wire:model.lazy="tenant_broker_other" class="form-control"
                                placeholder="Enter Tenant's Broker commission arrangement (e.g., $500 bonus plus 2% of net aggregate rent)">
                        </div>
                    </div>
                @endif
            @endif
