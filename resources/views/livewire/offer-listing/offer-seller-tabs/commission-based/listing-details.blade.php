...
<div class="dashboard-section">
    ...
    <div class="form-group">
        ...
        <span class="ms-2" data-bs-toggle="tooltip" data-bs-html="true"
            title="Enter a clear title for the property being offered for sale. Focus on the property's key features and location.">
            <i class="fa-solid fa-circle-info"></i>
        </span>
    ...
    {{-- A1.2–A1.4: Listing Type / Bidding Period restored for Seller (Create Offer). Buyer/Tenant remain Traditional-only via the bya_beta.bidding_period_enabled gate in their own partials. --}}
    <div class="form-group">
    ...
    <div class="alert alert-info small py-2 mt-2 mb-3" @if ($auction_type !== 'Bidding Period') style="display: none;" @endif wire:key="bp-notice-seller">
