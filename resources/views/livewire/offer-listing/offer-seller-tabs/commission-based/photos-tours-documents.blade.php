...
<div class="form-group">
    ...
    @if(count($propertyPhotos ?? []) < 50)
        <label for="property-photos-input-seller" id="seller-photo-dropzone"
...
<div class="form-group mt-4">
    ...
    @if ($videoTourUrl)
        @php $sellerEmbedUrl = \App\Support\VideoEmbedHelper::getEmbedUrl($videoTourUrl); @endphp
        @if ($sellerEmbedUrl)
            <div class="ratio ratio-16x9 mt-2" style="max-width: 560px;">
                <iframe src="{{ $sellerEmbedUrl }}"
...
(function () {
    ...
    function initSellerDropzone() {
        var dropzone = document.getElementById('seller-photo-dropzone');
