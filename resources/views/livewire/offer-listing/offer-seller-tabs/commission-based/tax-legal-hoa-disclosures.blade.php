...
<div class="alert alert-info bg-light-info border-info mb-4">
    <div class="d-flex align-items-center">
        <div>
            <strong>Provide tax, legal, flood zone, CDD/assessment, and HOA details so Agents and Buyers have the full picture of ongoing obligations and restrictions.</strong>
        </div>
    </div>
</div>
