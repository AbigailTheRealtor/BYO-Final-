        ...
        <form wire:submit.prevent="submit">
          ...
          <div class="tab-content mt-3">
            <div class="tab-pane fade {{ $activeTab === 0 ? 'show active' : '' }}">
                ...
                @include('livewire.buyer-agent-auction-bid-counter-tabs.broker-compensation')
            ...
            <div class="tab-pane fade {{ $activeTab === 2 ? 'show active' : '' }}" id="services">
              @include('livewire.buyer-agent-auction-bid-counter-tabs.services')
            </div>
            @if ($isListingCreatedByAgent)
            <div class="tab-pane fade {{ $activeTab === 3 ? 'show active' : '' }}">
              @include('livewire.buyer-agent-auction-bid-counter-tabs.referral-fee')
            </div>
            @endif
            @if ($isOfferListing)
            <div class="tab-pane fade {{ $activeTab === $clientDetailsIndex ? 'show active' : '' }}">
              @include('livewire.buyer-agent-auction-bid-counter-tabs.client-contact-information')
            </div>
            @endif
          </div>
