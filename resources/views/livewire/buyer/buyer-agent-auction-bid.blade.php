                        ...
                        @if ($service_type === 'full_service')
                            ...
                            <div class="tab-pane fade {{ $activeTab === 2 ? 'show active' : '' }}">
                                ...
                                <div class="form-group mb-4 mt-3">
                                    <label class="fw-semibold" for="referral_fee_percent_buyer_bid">Referral Fee (%) <span class="text-muted fw-normal">(Agent-to-Agent)</span></label>
                                    <input type="number"
                                           class="form-control mt-1"
                                           id="referral_fee_percent_buyer_bid"
                            ...
                            <div class="tab-pane fade {{ $activeTab === (5 + $tabOffset) ? 'show active' : '' }}">
                                @include('livewire.buyer-agent-auction-bid-tabs.commission-based.agent-experience')
                            </div>
