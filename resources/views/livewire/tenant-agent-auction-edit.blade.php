                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade {{ $activeTab === 0 ? 'show active' : '' }}" id="listing-details"
                                ...
                                <div class="mb-3 mt-3 px-1">
                                    <label class="form-label fw-semibold" for="referral_percentage_edit">Referral Percentage <span class="text-muted fw-normal">(%)</span></label>
                                    <input type="number"
                                           class="form-control"
                                           id="referral_percentage_edit"
...
@push('scripts')
    ...
    window.addEventListener('draft-saved', function(e) {
        ...
        if (!toast) {
            ...
            toast.innerHTML = '<i class="fas fa-check-circle me-1"></i><span id="draft-saved-msg"></span>'
