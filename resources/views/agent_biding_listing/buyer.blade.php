                            ...
                            <div class="container mt-4 myAuctions agent-bid-page">
                                ...
                                @if($auctions->isEmpty())
                                    <div class="text-center text-muted py-5">
                                        ...
                                        <p class="small mb-0">Browse live Buyer's Agent listings to place your first bid.</p>
                                    </div>
                                @else
                                    ...
                                    <tbody>
                                        @foreach ($auctions as $auction)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('buyer.view-auction', @$auction->id) }}">{{ @$auction->title }}</a></td>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a class="dropdown-item" href="{{ route('buyer.view-auction', @$auction->id) }}">
    ...
    <script>
        $(function() {
            $('.auction-type').on('change', function() {
                var val = $(this).val();
                window.location.href = '{{ route('buyer.biding.auctions.list') }}?type=' + val;
            });
        });
    </script>
@endpush
