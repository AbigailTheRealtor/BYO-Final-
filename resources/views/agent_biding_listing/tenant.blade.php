...
.agent-bid-card { border-left: 3px solid #049399 !important; }
</style>
@endpush
@section('content')
                    ...
                    <div class="rightCol col-sm-12 col-md-9 col-lg-9">
                        <div class="container mt-4 agent-bid-page">
                            ...
                            <div class="d-flex gap-2 mb-4 flex-wrap">
                                <a href="{{ route('tenant.biding.auctions.list') }}?type=2"
                                ...
                                <a href="{{ route('tenant.biding.auctions.list') }}?type=1"
                                ...
                                <a href="{{ route('tenant.biding.auctions.list') }}?type=3"
                            ...
                            @else
                                ...
                                @php
                                    ...
                                    // Key remaps (same as my-bids/agent-bids.blade.php)
                                    ...
                                    $canEditWithdraw = $userBid && !$isExpired
                                        && !in_array($bidStatus, ['Accepted', 'Rejected']);
                                @endphp

                                <div class="card mb-3 agent-bid-card" style="border-radius:8px;border:1px solid #dee2e6;">
                                    {{-- Card Header: Listing info + status + match score --}}
                                    ...
                                    @if($userBid)
                                    {{-- Card Body: Terms + Services breakdown --}}
                                    <div class="card-body">
                                        <div class="row">
