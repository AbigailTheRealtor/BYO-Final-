                                        ...
                                        <div class="mb-5">
                                            ...
                                            @php
                                                ...
                                                $hasAnySellerReviewUrl = !empty(array_filter((array) $sellerReviewLinks, fn($rl) => !empty(is_object($rl) ? ($rl->url ?? $rl->text ?? '') : ($rl['url'] ?? $rl['text'] ?? ''))));
                                            @endphp
                                        ...
                                        <div class="mb-5">
                                            ...
                                            @php
                                                ...
                                                $showSellerBrokerComp = $bidCommStruct || $bidCommStructType;
                                            @endphp
                                        ...
                                        <div class="mb-5">
                                            ...
                                            @php
                                                // BYA-H4: agent contact/credential fields display the agent's CURRENT
                                                // profile (live from the agent's user account) so they never go
                                                // stale, falling back to the bid-time snapshot when the live value
                                                // is empty. Negotiated TERMS / accepted-bid records stay snapshotted.
