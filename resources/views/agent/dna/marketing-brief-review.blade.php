...
<div class="container py-4">
    ...
    <div class="alert alert-warning border border-warning d-flex align-items-start gap-2 mb-4" role="alert">
        <strong>&#9888; Agent review only &mdash; deterministic internal marketing brief. Not public, not client-facing, and not AI-generated.</strong>
    </div>

    {{-- Back link --}}
    <div class="mb-3">
        <a href="{{ url()->previous() }}" class="btn btn-sm btn-outline-secondary">&larr; Back</a>
    </div>

    {{-- Profile header --}}
    <div class="card mb-4">
        <div class="card-header">
            <h5 class="mb-0">Marketing Brief &mdash; Profile #{{ $profile->id }}</h5>
            <div class="text-muted small mt-1">
                {{ ucfirst($profile->listing_type) }} listing / Listing {{ $profile->listing_id }} / Version {{ $profile->version }}
            </div>
        </div>
    </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body p-0">
            @if(empty($brief['property_attribute_context']))
                <p class="text-muted p-3 mb-0"><em>No data &mdash; section is empty.</em></p>
            @else
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            @empty
                <p class="text-muted mb-0"><em>No data &mdash; section is empty.</em></p>
            @endforelse
        </div>
    </div>
