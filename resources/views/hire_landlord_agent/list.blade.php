                            ...
                            @else
                                ...
                                <div class="listing-group-card" x-data="{ open: true }">
                                    ...
                                    <div class="listing-group-actions">
                                        <a href="{{ route('landlord.agent.auction.view', $auction->id) }}" class="btn btn-sm" style="background:#049399;color:#fff;border:none;">
                                    ...
                                    <div x-show="open" x-transition class="bids-area">
                                        ...
                                        @else
                                            ...
                                            @php
                                                ...
                                                $matchScore = \App\Helpers\LandlordBidMatchScoreHelper::calculate($auctionBaselineData, $bidData, null, $propType);
                                            ...
                                            <div class="bid-card">
                                                ...
                                                <div class="card-footer d-flex justify-content-end gap-2" style="background:#f8f9fa;">
                                                    <a href="{{ route('landlord.agent.auction.view', $auction->id) }}" class="btn btn-sm" style="background:#fff;border:1px solid #049399;color:#049399;">
                                                    ...
                                                    @if($bidStatus === 'Active')
                                                        ...
                                                        <a href="{{ route('landlord.agent.auction.counter-bid', [$auction->id, $bid->id]) }}" class="btn btn-sm" style="background:#ffc107;color:#000;border:none;">
                                                    ...
                                                    @elseif($bidStatus === 'Countered')
                                                        <a href="{{ route('landlord.hire.agent.auction.bid.view-counter', $bid->id) }}" class="btn btn-sm" style="background:#fff;border:2px solid #049399;color:#049399;padding:5px 12px;font-weight:600;font-size:0.85rem;">
                                                            <i class="fas fa-eye me-1"></i>View Counter Terms
                                                        </a>
                                                    @elseif($bidStatus === 'Accepted')
                                                        <a href="{{ route('landlord.agent.auction.view', $auction->id) }}" class="btn btn-sm" style="background:#28a745;color:#fff;border:none;">
