                                    ...
                                    <div class="row g-2 small">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="text-muted" style="font-size: 0.8rem;">
                                                ...
                                                @if ($brokerTotal > 0 && ($scoreResult['terms_changed_count'] ?? 0) > 0) &bull; Changed: {{ $scoreResult['terms_changed_count'] }}@endif
                                                @if ($brokerTotal > 0 && ($scoreResult['terms_added_count'] ?? 0) > 0) &bull; Added: {{ $scoreResult['terms_added_count'] }}@endif
                                            </div>
                                        </div>
                                    </div>
