...
@php
  ...
  // Milestone 3: $isBiddingPeriodListing was assigned here and never read. It is removed
  // with the bidding period itself.
...
<x-bid-detail-layout
    ...
    @php
        $p5BreakdownBuyer  = \App\Services\ScoreBreakdownService::breakdown($listingBaselineData, $currentBidData, 'buyer', $auctionPropType);
        $p6RecommendBuyer  = \App\Services\RecommendationService::consumerFitRecommendation($p5BreakdownBuyer, 'buyer');
    @endphp
    <x-recommendation-panel :recommendation="$p6RecommendBuyer" />
    <x-score-breakdown-panel :breakdown="$p5BreakdownBuyer" />
    ...
    <x-slot name="footerBanners">
        ...
        <div class="w-100 p-2 text-center" style="background: #ffc107; border-radius: 6px; color: #856404;">
            <i class="fa-solid fa-clock me-1"></i> Listing has expired — no further actions available.
        </div>
        @endif
