            ...
            <ul class="nav-menu custom-scrollbar" style="height: 100%;">
                ...
                <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i class="icofont icofont-users-alt-2 me-2"></i> <span>Users</span></a>
                    <ul class="nav-submenu menu-content">
                        {{-- <li><a class="submenu-title" href="javascript:void(0)">color version<span class="sub-arrow"><i class="fa-solid fa-chevron-right"></i></span></a> --}}
                        {{-- <ul class="nav-sub-childmenu submenu-content"> --}}
                        <li><a href="{{ route('admin.buyer') }}" class="fw-bold" ><i class="fa-solid fa-circle"></i> Buyer</a></li>
                        {{-- <li><a href="{{ route('admin.buyerAgent') }}" class="fw-bold"><i class="fa-solid fa-circle"></i> Buyer Agent</a></li> --}}
                        <li><a href="{{ route('admin.seller') }}" class="fw-bold"><i class="fa-solid fa-circle"></i> Seller</a></li>
                        {{-- <li><a href="{{ route('admin.sellerAgent') }}" class="fw-bold"><i class="fa-solid fa-circle"></i> Seller Agent</a></li> --}}
                        <li><a href="{{ route('admin.agent') }}" class="fw-bold"><i class="fa-solid fa-circle"></i> Agent</a></li>
                        <li><a href="{{ route('admin.userRequest') }}" class="fw-bold"><i class="fa-solid fa-circle"></i> Pending Approval</a></li>
                        <li><a href="{{ route('admin.addAdmin') }}" class="fw-bold"><i class="fa-solid fa-circle"></i> Admin Users</a></li>
                        {{-- </ul> --}}
                        {{-- </li> --}}
                    </ul>
                </li>
                ...
                <li><a class="nav-link menu-title" href="#"><i class="icofont icofont-growth me-2"></i> <span>Auctions</span></a>
                    <ul class="nav-submenu menu-content">
                        <li><a href="{{ route('admin.propertyAuctions') }}" class="fw-bold" ><i class="fa-solid fa-circle"></i> Seller's Property</a></li>
                        <li><a href="{{ route('admin.criteriaAuctions') }}" class="fw-bold" ><i class="fa-solid fa-circle"></i> Buyer's Criteria</a></li>
                        <li><a href="{{ route('admin.tenant.criteria.list') }}" class="fw-bold" ><i class="fa-solid fa-circle"></i> Tenant's Criteria</a></li>
                        <li><a href="{{ route('admin.serviceAuctions') }}" class="fw-bold" ><i class="fa-solid fa-circle"></i> Agent Service Needed</a></li>
                        {{-- <li><a href="{{ route('admin.sellerServiceAuctions') }}" class="fw-bold" ><i class="fa-solid fa-circle"></i> Seller Service Auctions</a></li> --}}
                        <li><a href="{{ route('admin.sellerAgentAuctions') }}" class="fw-bold" ><i class="fa-solid fa-circle"></i> Hire Seller's Agent</a></li>
                        <li><a href="{{ route('admin.buyerAgentAuctions') }}" class="fw-bold" ><i class="fa-solid fa-circle"></i> Hire Buyer's Agent</a></li>
                        <li><a href="{{ route('admin.landlord.auctions') }}" class="fw-bold" ><i class="fa-solid fa-circle"></i> Auctions for Landlords</a></li>
                        <li><a href="{{ route('admin.landlord.agent.auctions') }}" class="fw-bold" ><i class="fa-solid fa-circle"></i> Hire Landlord's Agent</a></li>
                        <li><a href="{{ route('admin.tenant.agent.auctions') }}" class="fw-bold" ><i class="fa-solid fa-circle"></i> Hire Tenant's Agent</a></li>
                        <li><a href="{{ route('admin.offerListings') }}" class="fw-bold" ><i class="fa-solid fa-circle"></i> Offer Listings</a></li>
                        <li><a href="{{ route('admin.referrals.index') }}" class="fw-bold" ><i class="fa-solid fa-share-alt me-1"></i> Referral Tracking</a></li>
                    </ul>
                </li>
