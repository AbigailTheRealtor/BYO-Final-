...
<div class="header">
    ...
    <div class="subHeader">
        <div class="container d-flex justify-content-between">
            <div class="left">
                <a href="{{ route('sellerWorks') }}">For Sellers</a>
                <a href="{{ route('sellerWorksAgent') }}">For Agents</a>
                <a href="{{ route('buyerWorks') }}">For Buyers</a>
            </div>
            <div class="right d-flex">
                    ...
                    <div class="dropdown dropdown-bubble">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item"
                                ...
                                <i class="fa-solid fa-house-user me-2 text-black"></i> Dashboard
                            </a>

                            @if (auth()->user()->user_type != 'admin')
                                <a class="dropdown-item" href="{{ route('settings') }}">
                                    <i class="fa-solid fa-user-tie me-2 text-black"></i> Profile Settings
                                </a>
                            @endif
                            ...
                            <a class="dropdown-item" href="{{ route('logout') }}">
                                <i class="fa-solid fa-right-from-bracket me-2 text-black"></i> Sign Out
                            </a>
                        </div>
                    </div>
                @else
                ...
                <div class="social">
                    ...
                    @else
                    <div class="social-icon-without-login">
    ...
    <div class="container d-flex justify-content-between">
        ...
        <nav>
            ...
            @else
                <a class="item" href="{{ route('login') }}">Sign In</a>
            @endif
            ...
            @if (auth()->user() && in_array(auth()->user()->user_type, ['agent']))
                <span class="dropdown">
                    ...
                    <ul class="dropdown-menu" style="margin-top:0px;">
                        <li><a style="color: #333;" class="dropdown-item" href="{{ route('hire.agent.auction', ['user_type' => 'tenant']) }}"><i class="fa fa-key me-2 text-muted"></i>Hire Tenant's Agent</a></li>
                        <li><a style="color: #333;" class="dropdown-item" href="{{ route('hire.agent.auction', ['user_type' => 'landlord']) }}"><i class="fa fa-building me-2 text-muted"></i>Hire Landlord's Agent</a></li>
                        <li><a style="color: #333;" class="dropdown-item" href="{{ route('hire.agent.auction', ['user_type' => 'buyer']) }}"><i class="fa fa-search me-2 text-muted"></i>Hire Buyer's Agent</a></li>
                        <li><a style="color: #333;" class="dropdown-item" href="{{ route('hire.agent.auction', ['user_type' => 'seller']) }}"><i class="fa fa-gavel me-2 text-muted"></i>Hire Seller's Agent</a></li>
                    </ul>
                </span>
                ...
                <div class="offcanvas-body">
                    <ul>
                        ...
                        <li>
                            ...
                            @elseif (auth()->user() && auth()->user()->user_type == 'buyer')
                                <a href="{{ route('buyer.add-auction') }}"><button class="btn">Hire Agent</button></a>
                            @elseif (auth()->user() && auth()->user()->user_type == 'landlord')
                                <a href="{{ route('landlord.hire.agent.auction') }}"><button class="btn">Hire Agent</button></a>
                            @elseif (auth()->user() && auth()->user()->user_type == 'tenant')
                                <a href="{{ route('hire.agent.auction', ['user_type' => 'tenant']) }}"><button class="btn">Hire Agent</button></a>
                            @else
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function renderBadge(count) {
            ...
            if (count > 0 && bellIcon) {
                ...
                span.style.cssText =
                    'position: absolute;top: -14.5px;right: -24px;background-color: red;color: white;padding: 4px 8px;border-radius: 50%;font-size: 12px;margin-right: 15px;}';
        ...
        function renderNotifications(notifications) {
            ...
            markAllLi.innerHTML =
                `<button class="btn btn-sm btn-light w-100" onclick="markAllAsRead()">Mark All as Read</button>`;
        ...
        window.markAsRead = function(id, el) {
            fetch('{{ route('notifications.markRead') }}', {
                ...
                .then(() => {
                    ...
                    if (!remaining) dropdown.innerHTML =
                        '<li class="dropdown-item text-center text-muted">No new notifications</li>';
                })
                .catch(console.error);
        }
