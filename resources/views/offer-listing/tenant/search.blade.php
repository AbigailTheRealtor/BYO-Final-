...
@section('content')
    ...
    <div class="buyerOfferContentDetails">
        <div class="container">
            <p><span><b>Browse Tenant Criteria Listings</b></span> <span><i>{{ $count }} results</i></span></p>
            ...
            <div class="cardsDetails row justify-content-start">
                ...
                {{-- Search card audit (Task 1416): no Hire-Agent-only fields displayed here.
                     Card renders only: listing title, property type, property style, beds/baths/sqft
                     (residential), county, "Tenant Criteria" badge, bidding-period countdown timer,
                     and rent budget. Service type, broker compensation, agency agreement, referral
                     percentage, and all other Hire-Agent terms are intentionally absent. --}}
                @forelse ($pAuctions as $auction)
                    @php
                        ...
                        $sqftDisplay = @$auction->get->minimum_heated_square ?? @$auction->get->minimum_net_leasable_square ?? '';
                        ...
                        <div class="card position-relative" style="overflow: hidden;">
                            <div class="card-body pb-2 pt-2">
                                ...
                                <div class="houseDetails mb-1">
                                    <p class="mb-1 fw-bold text-muted small">Tenant Criteria Listing &bull; {{ $propertyTypeLabel }}</p>
                                    ...
                                    <p class="mb-1">&#x1F50D; Tenant Criteria</p>
