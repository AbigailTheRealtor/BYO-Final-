...
@section('content')
    ...
    <div class="buyerOfferContentDetails">
        <div class="container">
            <p><span><b>Browse Rental Properties</b></span> <span><i>{{ $count }} results</i></span></p>
            ...
            <div class="cardsDetails row justify-content-start">
                ...
                @forelse ($pAuctions as $auction)
                    @php
                        ...
                        $bedsDisplay = $resolveOther(@$auction->get->bedrooms, @$auction->get->custom_bedrooms);
                        $bathsDisplay = $resolveOther(@$auction->get->bathrooms, @$auction->get->custom_bathrooms);
                        $sqftDisplay = @$auction->get->heated_sqft ?? @$auction->get->heated_square_footage ?? '';

                        $countyDisplay = '';
                        $propCounty = trim((string)(@$auction->get->property_county ?? @$auction->get->county ?? ''));
                        if (!empty($propCounty)) {
                        ...
                        <div class="card" style="overflow: hidden; cursor: pointer; transition: box-shadow .15s;">
                            <div class="card-body pb-2 pt-2">
                                ...
                                <div class="houseDetails mb-1">
                                    <p class="mb-1 fw-bold text-muted small">Rental Property &bull; {{ $propertyTypeLabel }}</p>
                                    ...
                                    <p class="mb-1">&#x1F3E0; Rental Property</p>
