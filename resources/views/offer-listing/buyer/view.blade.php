...
<div class="container listingDescription bol-view-page">
    ...
    @php ob_start(); @endphp
            ...
            @php
                ...
                // The rule lives in ContingencyOptionHelper so Ask AI applies the same one.
                $__buyerShowsPeriod = fn ($v) => \App\Helpers\ContingencyOptionHelper::buyerShowsPeriod((string) $v);
            ...
            <hr>
            @if(\App\Helpers\ContingencyOptionHelper::buyerHomeSaleShown($str('home_sale_contingency')))
    ...
    @include('offer-listing.partials._ask-ai-question-modal', [
        ...
        'prefix'        => 'bol',
        'modalId'       => 'bolAiModal',
        'title'         => 'Ask AI About This Buyer Listing',
        'questions'     => $propertyQuestions ?? [],
        'meta'          => $meta ?? [],
        'viewerIsOwner' => $askAiViewerIsOwner ?? false,
