...
<head>
    ...
    <title>Beta Compatibility Insight</title>
    <link rel="stylesheet" href="{{ asset('css/app.css') }}">
    <style>
        body { background: #f8f9fa; font-family: sans-serif; }
        .beta-container { max-width: 800px; margin: 2rem auto; padding: 0 1rem; }
        .disclaimer-banner {
            background: #fff3cd;
...
<div class="beta-container">
    ...
    <div class="disclaimer-banner" role="note">
        <strong>Beta Compatibility Insight</strong>
            ...
            <div style="overflow-x:auto;">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <span style="font-size:.8rem;color:#555;">{{ $row['dimension'] ?? '—' }}</span>
                            </td>
                            <td>
                                @if($cat)
