...
<div class="mb-3 d-flex align-items-center gap-2 flex-wrap">
    ...
    @endif
    <span class="text-muted small">/ Tenant DNA Profile — Listing {{ $listingId }}</span>
</div>
...
<div class="alert alert-info d-flex align-items-start gap-2 mb-0">
    ...
    <div>
        ...
        No active (non-archived) Tenant DNA profile exists for listing ID <strong>{{ $listingId }}</strong>. A profile will appear here once the DNA computation has been run for this listing.
    </div>
</div>
@else
...
<div class="card mb-4">
    <div class="card-header d-flex align-items-center gap-2 flex-wrap">
        <h5 class="mb-0">Tenant DNA Profile</h5>
