...
<div class="p-3">
    ...
    @if($pendingAgentBids->count() > 0)
        ...
        @php
            ...
            $listingId = $agentBid->auction->listing_id ?? 'BAA-'.$agentBid->auction->id;
        ...
        <div class="card mb-3" style="border: 1px solid #dee2e6; border-radius: 8px;">
            ...
            <div class="card-footer d-flex justify-content-end gap-2" style="background: #f8f9fa;">
                ...
                @if($bidStatus === 'Active')
                    ...
                    <a href="{{ route('buyer.counter-terms', $agentBid->id) }}" class="btn btn-sm" style="background: #ffc107; color: #000; border: none;">
