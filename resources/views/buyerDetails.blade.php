...
@section('content')
    <div class="container">
        ...
        <div class="sellerWorkAuction">
            <div class="mb-4">
                <h2 class="fw-bold mb-1">How Buyer Listings Work</h2>
                <p class="text-muted">Everything you need to know about creating a listing and hiring a buyer's agent on BidYourAgent.</p>
                <hr>
            </div>
            <div class="d-flex">
