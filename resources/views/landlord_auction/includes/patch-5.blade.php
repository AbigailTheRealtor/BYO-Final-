<div class="wizard-step" data-step='47'>
    ...
    @foreach ($listing_ai_faq_questions as $categoryKey => $category)
        ...
        @foreach ($category['questions'] as $questionKey => $questionText)
            <div class="form-group">
                ...
                <textarea name="listing_ai_faq[{{ $questionKey }}]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
            </div>
        @endforeach
    @endforeach
    ...
    <div class="commercial_show d-none">
        ...
        <div class="form-group">
            <label class="fw-bold">What is the zoning classification of the property?</label>
            <textarea name="listing_ai_faq[commercial_zoning_classification]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">What is the permitted use of the space?</label>
            <textarea name="listing_ai_faq[commercial_permitted_use]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">Is the lease gross, net, modified gross, or triple net (NNN)?</label>
            <textarea name="listing_ai_faq[commercial_lease_structure_type]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">What operating expenses is the tenant responsible for?</label>
            <textarea name="listing_ai_faq[commercial_tenant_operating_expenses]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">What are the CAM (Common Area Maintenance) charges?</label>
            <textarea name="listing_ai_faq[commercial_cam_charges]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">Are there annual rent escalation clauses?</label>
            <textarea name="listing_ai_faq[commercial_rent_escalation_clauses]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">Is a tenant improvement (TI) allowance available?</label>
            <textarea name="listing_ai_faq[commercial_tenant_improvement_allowance]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">What is the base rent per square foot per year?</label>
            <textarea name="listing_ai_faq[commercial_base_rent_per_sqft]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">Are signage rights included?</label>
            <textarea name="listing_ai_faq[commercial_signage_rights]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">What are the hours of access to the building or suite?</label>
            <textarea name="listing_ai_faq[commercial_building_access_hours]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">Is there shared conference room or lobby space?</label>
            <textarea name="listing_ai_faq[commercial_shared_conference_lobby]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">What is the parking ratio (spaces per 1,000 sq ft)?</label>
            <textarea name="listing_ai_faq[commercial_parking_ratio]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">Are there loading dock or freight elevator facilities?</label>
            <textarea name="listing_ai_faq[commercial_loading_dock_freight_elevator]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">What is the electrical capacity of the space (amperage/voltage)?</label>
            <textarea name="listing_ai_faq[commercial_electrical_capacity]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">Are there exclusivity rights preventing competing businesses in the building?</label>
            <textarea name="listing_ai_faq[commercial_exclusivity_rights]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">What is the sublease and assignment policy?</label>
            <textarea name="listing_ai_faq[commercial_sublease_assignment_policy]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">Is there an option to expand or right of first refusal on adjacent space?</label>
            <textarea name="listing_ai_faq[commercial_expansion_option_rofr]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">What are the lease renewal options and terms?</label>
            <textarea name="listing_ai_faq[commercial_lease_renewal_options]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">Are there any co-tenancy clauses or kick-out clauses?</label>
            <textarea name="listing_ai_faq[commercial_cotenancy_kickout_clauses]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
        <div class="form-group">
            <label class="fw-bold">Who is responsible for HVAC maintenance and replacement?</label>
            <textarea name="listing_ai_faq[commercial_hvac_responsibility]" class="form-control" rows="2" placeholder="Optional — enter your answer here"></textarea>
        </div>
    </div>
</div>
