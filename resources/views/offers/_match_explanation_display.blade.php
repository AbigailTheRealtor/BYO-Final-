{{--
    ...
    Available from caller:
      ...
      $offer — Offer model (optional; used for role-aware labels)

    Renders nothing when neither field is populated.
--}}
@php $dispMatchRole = $offer->role ?? 'buyer'; @endphp
...
<dl class="row mb-0">
    ...
    <dt class="col-sm-3">{{ $dispMatchRole === 'tenant' ? 'Why This Rental Matches' : 'Why This Property Matches' }}</dt>
