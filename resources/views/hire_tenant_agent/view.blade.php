...
<div class="col-sm-12 col-md-4 col-lg-4 rightCol">
    ...
    <div class="mb-2">
        ...
        @endphp
        <span class="badge" style="{{ $statusStyle }} font-size:0.875rem;border-radius:9999px;padding:0.25rem 0.75rem;font-weight:500;box-shadow:0 1px 2px rgba(0,0,0,.05);"><i class="fa {{ $statusIcon }} me-1"></i>Status: {{ $_displayStatusLabel }}</span>
    </div>
    @endif
