                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content" style="border-radius: 10px; border: none;">
                                                ...
                                                <div class="modal-body" style="background: #fafafa; padding: 25px;">
                                                    ...
                                                    {{-- Section 2: Offered Services - Reuse variables from full modal context --}}
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        @if ($hasAnyBidServices)
                                                            @foreach ($bidCategories as $catName => $catServices)
                                                                @php
                                                                    $matchedSvcs = array_filter($bidAllServices, function($svc) use ($catServices) {
