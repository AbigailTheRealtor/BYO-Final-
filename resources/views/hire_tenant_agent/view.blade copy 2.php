        ...
        <div class="card description">
          ...
          <div class="card-body">
            <div class="row" style="flex-wrap: wrap;">
              ...
              @if (@$auction->get->cities != null)
                <div class="col-md-12 col-12 pt-2 fw-bold"><i class="fa-regular fa-check-square"></i> City:
                  ...
                  {{-- <span class="removeBold">{{ json_decode($auction->get->cities) }}</span> --}}
              ...
              @if (@$auction->get->counties != null)
                <div class="col-md-12 col-12 pt-2 fw-bold"><i class="fa-regular fa-check-square"></i> County:
                  @if (gettype(@$auction->get->counties) == 'array')
                    ...
                    @endforeach
                  @endif
                  {{-- <span class="removeBold">{{ json_decode($auction->get->counties) }}</span> --}}
              ...
              @if (@$auction->get->view_preference != null ||  $auction->get->other_preferences !=null)
                <div class="col-md-12 col-12 pt-2 fw-bold"><i class="fa-regular fa-check-square"></i> View Preference
                  Needed:
                  @if (gettype(@$auction->get->view_preference) == 'array')
                  @foreach (@$auction->get->view_preference as $item)
                    <span class="removeBold">{{ $item }}</span>
                  @endforeach
                  @elseif(@$auction->get->other_preferences)
              ...
              @endif
              <div class="col-md-12 col-12 pt-2 fw-bold"><i class="fa-regular fa-check-square"></i> EEligibility/Interest in Leasing in 55-and-Over Communities:
                <span class="removeBold">
            ...
            <div class="col-md-12 col-12 pt-2 fw-bold"><i class="fa-regular fa-check-square"></i> Offered Lease Length:
              <span class="removeBold">
                @foreach (array_filter(@$auction->get->lease_for) as $item)
                    <span class="removeBold"> {{ $item }}</span>
            ...
            @endif
            @if($auction->get)
                <div class="col-md-12 col-12 pt-2 fw-bold"><i class="fa-regular fa-check-square"></i> Total Monthly Net Household Income:
                <span class="removeBold">
            ...
            @if (@$auction->get->credit_scroe_rating != null)

                <div class="col-md-12 col-12 pt-2 fw-bold"><i class="fa-regular fa-check-square"></i> Tenant(s) Credit Score Rating:
            
                    @foreach (@$auction->get->credit_scroe_rating as $item)
                      <span class="removeBold">{{ $item }}</span>
                    @endforeach

            @endif

              <div class="col-md-12 col-12 pt-2 fw-bold"><i class="fa-regular fa-check-square"></i> Prior Eviction(s) in the Last 7 Years:<span class="removeBold">({{ @$auction->get->prior_eviction }})</span>

              </div>
              <div class="col-md-12 col-12 pt-2 fw-bold"><i class="fa-regular fa-check-square"></i> Prior Felony Conviction(s) in the Last 7 Years:<span class="removeBold">({{ $auction->get->prior_felony ?? '' }})</span>
              </div>
            <hr>
            <div class="card-header">
            ...
            <div class="col-md-12 col-12 pt-2 fw-bold"><i class="fa-regular fa-check-square"></i>Tenant Agency Agreement Timeframe:
              <span class="removeBold">
              ...
              <div class="col-md-12 col-12 pt-2 fw-bold"><i class="fa-regular fa-check-square"></i> Services the Tenant Requests from Their Agent:
                ...
                @if (@$auction->get->services != null ||  $auction->get->other_services !=null)
                    @if (gettype(@$auction->get->services) == 'array')

                        @foreach (@$auction->get->services as $item)
                            <span class="removeBold">{{ $item }}</span>
                        @endforeach
                        @elseif(@$auction->get->other_services)
                        <span class="removeBold">({{ @$auction->get->other_services }})</span>
                    @endif
            ...
            @if ($auction->get->first_name != null)
            ...
            @endif
            @if ($auction->get->phone_number != null)
              <div class="col-md-12 col-12 pt-2 fw-bold"><i class="fa-regular fa-check-square"></i> Phone:
                <span class="removeBold">
                  {{ $auction->get->phone_number }}
                </span>
              </div>
            @endif
            @if ($auction->get->video_link != null)
              <div class="col-md-12 col-12 pt-2 fw-bold"><i class="fa-regular fa-check-square"></i> Link:
                <span class="removeBold">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-6 pt-2 fw-bold">Video:
                  ...
                  <div class="col-md-6 col-6 pt-2 fw-bold">Photo:
                    <span class="removeBold">
                        <img src="{{ asset('storage/auction/images/' . $auction->get->photo) }}" style="width:100%;height:29vh;" />
                    </span>
                  </div>
                @endif
            </div>
