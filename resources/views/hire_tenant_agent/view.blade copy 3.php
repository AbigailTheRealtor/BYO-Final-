    ...
    <div class="container listingDescription">
        <div class="row">
                        ...
                        @if (
                            ...
                            <ul>
                                <li style="font-size: 16px;">${{ $auction->get->lease_fee_flat_combo }} +
                                    {{ $auction->get->lease_fee_percentage_combo }}%</li>
                            </ul>
                        @endif
                        ...
                        @if (
                            ...
                            <ul>
                                <li style="font-size: 16px;">${{ $auction->get->lease_fee_flat_combo_net }} +
                                    {{ $auction->get->lease_fee_percentage_combo_net }}%</li>
                            </ul>
                        @endif
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 rightCol">
                ...
                @php
                    // Parse expiration date (UTC or your timezone)
                    ...
                    if ($expiration && !$isExpired) {
                        $start = $carbon::now();
                        $diff_d = $start->diffInDays($expiration);
                        $diff_H = $start->diff($expiration)->format('%H');
                        $diff_I = $start->diff($expiration)->format('%I');
                        $diff_S = $start->diff($expiration)->format('%S');
                    }
                @endphp
