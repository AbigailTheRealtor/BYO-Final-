                                ...
                                <table class="table table-hover data-table" style="border-collapse:separate;border-spacing:0;">
                                    ...
                                    <tbody>
                                            @foreach ($auctions as $auction)
                                                ...
                                                @php
                                                    $counter = App\Models\TenantCounterTerm::where('tenant_agent_auction_id', @$auction->id)->first();
                                                @endphp
                                                <tr>
                                                    <td class="align-middle">
                                                        <a href="{{ route('tenant.agent.view.auction.view', @$auction->id) }}" class="fw-semibold text-decoration-none" style="color:#049399;">{{ @$auction->title }}</a>
                                                    ...
                                                    <td class="align-middle" style="min-width:170px;">
                                                        <a href="{{ route('tenant.agent.view.auction.view', @$auction->id) }}" class="btn btn-sm d-block mb-1" style="background:#049399;color:#fff;">Review Bids</a>
                                                        ...
                                                        @endif
                                                        @if (isset($counter))
                                                            <a href="{{ route('tenant.edit-counter-terms', $auction->id) }}" class="btn btn-sm d-block mb-1" style="border:1px solid #049399;color:#049399;background:transparent;">Edit Counter Terms</a>
                                                            <button type="button" class="btn btn-sm d-block w-100" style="border:1px solid #6c757d;color:#6c757d;background:transparent;" data-bs-toggle="modal" data-bs-target="#modal-{{ $auction->id }}">View Counter Terms</button>
                                                        @endif
                                                    </td>
                                                </tr>
                                                {{-- Modal --}}
