...
**Approval scope:** Architecture, phases, gates, invariants, and the parallelization plan. **Implementation is underway:** Phase 0 Batch 1 landed in `3fdc4a714`, with a follow-up in `f3dab6f24`; Batch 2 landed in `009898269`; Batch 3 in `841147d9f`; Batch 4 in `31457f36f`; Batch 5 in `8d576abd2`. Together they produced errata **E-37**–**E-46**, decisions **SIA-D34**/**SIA-D35**, and open question **Q12**. **Phase 0 status:** items 1, 2, 6, 7 **complete**; items 3–5 blocked on **Q1**; items 8–9 downstream of those. Phase 0 cannot be declared complete until Q1 is answered, and INV-11 holds in tests only until **Q12** closes. Phase 0 remains blocked on Q1 (hosting target) for items 3–5; items 1, 2, 6, and 7 are unblocked.
