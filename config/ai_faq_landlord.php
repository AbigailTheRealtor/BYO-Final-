...
return [
    ...
    | Source: landlord_auction/includes/patch-5.blade.php (lines 1–236)
    |
    */
    ...
    |
    | Source in landlord_auction/includes/patch-5.blade.php:
    |   .commercial_show.d-none  (shown via JS when property_type is Commercial)
    |
    */
