...
/*
|--------------------------------------------------------------------------
| Overture chain registry — chain-registry-v1
|--------------------------------------------------------------------------
|
...
| Factual basis: docs/spatial/overture-corpus-v2-design.md (PR 0, Overture 2026-08-19.0).
|
| EVIDENCE — every rule-bearing entry carries one:
|   M  measured in PR 0 (a count, QID or observed name)
    ...
    'chains' => [
        ...
        'walmart' => [
            ...
            'allowed_categories' => [
                ...
                'grocery_store'    => ['role' => 'department', 'evidence' => 'D: v2 §7'],
            ...
            'formats' => [
                ...
                'supercenter' => [
                    'categories' => ['superstore', 'department_store'],
        ...
        'cvs' => [
            ...
            'formats' => [
                ...
                'store_in_target' => [
                    ...
                    'role' => 'storefront',
                    'evidence' => 'D: v2 decision 3b; name shape P',
                ],
            ],
            'default_format' => 'store',
            'validation_status' => 'provisional',
            'notes' => ['The 195 CVS rows classified `shopping` are not rescued in v1 (decision 11); PR 3 measures them.'],
        ],
        ...
        'racetrac' => [
            ...
            'brand_aliases' => [
                ['value' => 'racetrac', 'evidence' => 'M: identity for location-only names ("Polo", "Lake Mary") (v2 §7)'],
            ],
            ...
            'allowed_categories' => [
                'convenience_store' => ['role' => 'storefront', 'evidence' => 'P'],
                'gas_station'       => ['role' => 'fuel', 'evidence' => 'M: gas rows (v2 §6)'],
            ],
            'formats' => [
                'store' => ['categories' => ['convenience_store'], 'role' => 'storefront', 'evidence' => 'P'],
                'fuel'  => ['categories' => ['gas_station'], 'role' => 'fuel', 'evidence' => 'P'],
        ...
        'mcdonalds' => [
            ...
            'excluded_categories' => [
                'coffee_shop' => 'D: chain-registry decision 3 (no McCafé identity in v1)',
                'cafe'        => 'D: chain-registry decision 3',
                'restaurant'  => 'D: chain-registry decision 4',
            ],
            'formats' => [
