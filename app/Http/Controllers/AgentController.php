...
class AgentController extends Controller
{
    ...
    public function offerListingView(int $id)
    {
        ...
        $data = [
            ...
            'utilities'              => $parseJsonMeta('utilities'),
            ...
            // Seller lease-purchase specifics
            ...
            'other_services'               => $parseJsonMeta('other_services'),
            ...
            'laundry_features'           => $parseJsonMeta('laundry_features'),
            ...
            'space_type'                       => $parseJsonMeta('space_type'),
            'space_classification'             => $parseJsonMeta('space_classification'),
            ...
            'exchange_liens_disclosure'                    => $meta['exchange_liens_disclosure']                    ?? '',
            'exchange_liens'                               => $meta['exchange_liens']                               ?? '',
            'number_of_unit_type'                          => $parseJsonMeta('number_of_unit_type'),
