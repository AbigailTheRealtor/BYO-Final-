...
class BuyerAgentAuctionController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return view('buyerAgentAuctionList', $page_data);
    }
    public function viewAuctionDetails($id)
    {
         ...
         */
        $hlaViewerIsOwner = $proposalAccess->isListingOwner(auth()->id(), $auction);
    ...
    public function searchListing(Request $request)
    {
        ...
        $auctions->selectRaw("*, (SELECT meta_value FROM buyer_agent_auction_metas WHERE buyer_agent_auction_metas.buyer_agent_auction_id = buyer_agent_auctions.id AND meta_key = 'ideal_price') as price")
            ->where(function($q) {
