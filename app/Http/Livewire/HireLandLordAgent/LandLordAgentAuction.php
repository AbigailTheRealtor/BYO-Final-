...
class LandLordAgentAuction extends Component
{
    ...
    public function mount($listingId = null)
    {
        ...
        if ($listingId) {
            // S1 (unchanged): the existing 403 ownership check stays exactly as it was.
        ...
        try {
            ...
            if ($this->address) {
                try {
                    ...
                    \Log::warning('[HIRE LANDLORD AGENT DRAFT] coordinate resolution failed', [
        ...
        try {
            ...
            if ($this->address) {
                try {
                    ...
                    \Log::warning('[HIRE LANDLORD AGENT STORE] coordinate resolution or ComputeLocationDna dispatch failed', [
                        'listing_id' => $this->listingId,
