...
class LandlordOfferListingEdit extends Component
{
    ...
    public $custom_smoking_policy_requirement = '';
    public $criminal_background_requirement = '';
    ...
    // Misc visibility flags and other
     ...
     * write action is reachable for an unauthorized user. See ResolvesOwnedAuction.
     */
    public function hydrate()
    {
        ...
        $this->assertCanManageAuction(
            HirelandLordAgentAuction::class,
    ...
    protected function buildDraftPayload(): array
    {
        ...
        $data = [
            ...
            'zipCodes'                        => json_encode($this->ensureArray($this->zipCodes)),
            ...
            'minimum_heated_square'           => $this->minimum_heated_square,
            ...
            'appliances'                      => json_encode($this->ensureArray($this->appliances)),
            'appliances_other'                => $this->appliances_other,
            ...
            'assignment_fee_amount'           => $this->assignment_fee_amount,
            'buyer_sell_contract'             => $this->buyer_sell_contract,
            'maximum_budget'                  => $this->maximum_budget,
            'offered_financing'               => json_encode($this->ensureArray($this->offered_financing)),
            ...
            'seller_financing_amount'         => $this->seller_financing_amount,
            'interest_rate'                   => $this->interest_rate,
            'loan_duration'                   => $this->loan_duration,
            'prepayment_penalty'              => $this->prepayment_penalty,
            'prepayment_penalty_amount'       => $this->prepayment_penalty_amount,
            ...
            'gap_payment_amount'              => $this->gap_payment_amount,
            ...
            'lease_option_price'              => $this->lease_option_price,
            ...
            'option_fee_amount'               => $this->option_fee_amount,
            'lease_purchase_price'            => $this->lease_purchase_price,
            ...
            'lease_purchase_option_fee_amount' => $this->lease_purchase_option_fee_amount,
            ...
            'tenant_pays'                     => json_encode($this->ensureArray($this->tenant_pays)),
            'owner_pays'                      => json_encode($this->ensureArray($this->owner_pays)),
            'other_tenant_pays'               => $this->other_tenant_pays,
            'other_owner_pays'                => $this->other_owner_pays,
            'tenant_pays_other'               => $this->tenant_pays_other,
            ...
            'view_preference'                 => json_encode($this->ensureArray($this->view_preference)),
            ...
            'minimum_annual_net_income'       => $this->minimum_annual_net_income,
            ...
            'maintenance_handler'             => $this->maintenance_handler,
            'included_storage_space'          => $this->included_storage_space,
            'storage_space'                   => $this->storage_space,
            'non_negotiable_amenities'        => json_encode($this->ensureArray($this->non_negotiable_amenities)),
            'other_non_negotiable_amenities'  => $this->other_non_negotiable_amenities,
            'budget'                          => $this->budget,
            'lease_for'                       => json_encode($this->ensureArray($this->lease_for)),
            ...
            'credit_scroe_rating'             => json_encode($this->ensureArray($this->credit_scroe_rating)),
            ...
            'landlord_broker_purchase_price'  => $this->landlord_broker_purchase_price,
            'landlord_broker_percentage_price' => $this->landlord_broker_percentage_price,
            'landlord_broker_dollar_price'    => $this->landlord_broker_dollar_price,
            ...
            'interested_in_property_management_fee_flate_free' => $this->interested_in_property_management_fee_flate_free,
            ...
            'renewal_fee_flat_free'           => $this->renewal_fee_flat_free,
            ...
            'photo_enhancements'              => json_encode($this->ensureArray($this->photo_enhancements)),
            ...
            'air_conditioning'                => json_encode($this->ensureArray($this->air_conditioning)),
            'other_air_conditioning'          => $this->other_air_conditioning,
            'water'                           => json_encode($this->ensureArray($this->water)),
            'other_water'                     => $this->other_water,
            'sewer'                           => json_encode($this->ensureArray($this->sewer)),
            'other_sewer'                     => $this->other_sewer,
            'property_utilities'              => json_encode($this->ensureArray($this->property_utilities)),
            'other_property_utilities'        => $this->other_property_utilities,
            'laundry_features'                => json_encode($this->ensureArray($this->laundry_features)),
            'other_laundry_features'          => $this->other_laundry_features,
            'floor_covering'                  => json_encode($this->ensureArray($this->floor_covering)),
            'other_floor_covering'            => $this->other_floor_covering,
            'security_features'               => json_encode($this->ensureArray($this->security_features)),
            'other_security_features'         => $this->other_security_features,
            'zoning'                          => $this->zoning,
            'total_buildings'                 => $this->total_buildings,
            'total_units_on_property'         => $this->total_units_on_property,
            'office_retail_sqft'              => $this->office_retail_sqft,
            'flex_space_sqft'                 => $this->flex_space_sqft,
            'road_surface_type'               => json_encode($this->ensureArray($this->road_surface_type)),
            'other_road_surface_type'         => $this->other_road_surface_type,
            'electrical_service'              => json_encode($this->ensureArray($this->electrical_service)),
            'other_electrical_service'        => $this->other_electrical_service,
            'ceiling_height'                  => $this->ceiling_height,
            'building_features'               => json_encode($this->ensureArray($this->building_features)),
            ...
            'number_gas_meters'               => $this->number_gas_meters,
            'space_type'                      => json_encode($this->ensureArray($this->space_type)),
            'other_space_type'                => $this->other_space_type,
            'space_classification'            => json_encode($this->ensureArray($this->space_classification)),
            'other_space_classification'      => $this->other_space_classification,
            'number_of_restrooms'             => $this->number_of_restrooms,
            'number_of_offices'               => $this->number_of_offices,
            'number_of_conference_rooms'      => $this->number_of_conference_rooms,
            ...
            'net_aggregate_rent'              => $this->net_aggregate_rent,
            'month_percentage_rent'           => $this->month_percentage_rent,
            'no_of_months'                    => $this->no_of_months,
            'flat_fee'                        => $this->flat_fee,
            'gross_percentage_rent'           => $this->gross_percentage_rent,
            ...
            'expansion_flat_fee'              => $this->expansion_flat_fee,
            'expansion_custom_commission'     => $this->expansion_custom_commission,
            ...
            'custom_services'                 => json_encode($this->ensureArray($this->custom_services)),
            'total_marketing_fee'             => $this->total_marketing_fee,
            'total_flat_fee'                  => $this->total_flat_fee,
            'fees'                            => json_encode($this->ensureArray($this->fees)),
            'enable'                          => json_encode($this->ensureArray($this->enable)),
            ...
            'landlord_approval_conditions'    => $this->landlord_approval_conditions,
            'additional_landlord_lease_terms' => $this->additional_landlord_lease_terms,
            'commercial_lease_type'           => $this->commercial_lease_type,
            'commercial_lease_type_other'     => $this->commercial_lease_type_other,
            'cam_nnn_additional_rent_charges' => $this->cam_nnn_additional_rent_charges,
            'rent_escalation_terms'           => $this->rent_escalation_terms,
            'tenant_improvement_buildout_terms' => $this->tenant_improvement_buildout_terms,
            'permitted_use_restrictions'      => $this->permitted_use_restrictions,
            'signage_rights'                  => $this->signage_rights,
            'commercial_parking_terms'        => $this->commercial_parking_terms,
            'personal_guarantee_requirement'  => $this->personal_guarantee_requirement,
            ...
            'landlord_disclosure_available'   => $this->landlord_disclosure_available,
            ...
            'landlord_doc_rows'               => json_encode($this->landlord_doc_rows),
            'landlord_disclosure_file_path'   => $this->landlord_disclosure_file_path,
    ...
    public function saveDraftOnly()
    {
        try {
            ...
            $auction = HirelandLordAgentAuction::find($this->auctionId);
            if (!$auction) {
    ...
    public function loadAuctionData($listingId)
    {
        ...
        if ($auction) {
            ...
            $this->property_items = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            ...
            $this->offered_financing = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            ...
            $this->tenant_require = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            ...
            $this->rent_includes = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);

            $raw = $auction->get->terms_of_lease ?? null;
            $this->terms_of_lease = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            ...
            $this->is_other_appliances_visible = is_array($this->appliances) && in_array('Other', $this->appliances);
            ...
            $this->pool_type = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);




            $raw = $auction->get->view_preference ?? null;
            $this->view_preference = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            ...
            $this->lease_for = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            ...
            $this->credit_scroe_rating = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            ...
            $raw = $auction->get->heating_fuel ?? null;
            $this->heating_fuel = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            $this->other_heating_fuel = $auction->get->other_heating_fuel ?? '';
            $raw = $auction->get->air_conditioning ?? null;
            $this->air_conditioning = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            $this->other_air_conditioning = $auction->get->other_air_conditioning ?? '';
            $raw = $auction->get->water ?? null;
            $this->water = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            $this->other_water = $auction->get->other_water ?? '';
            $raw = $auction->get->sewer ?? null;
            $this->sewer = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            $this->other_sewer = $auction->get->other_sewer ?? '';
            $raw = $auction->get->property_utilities ?? null;
            $this->property_utilities = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            $this->other_property_utilities = $auction->get->other_property_utilities ?? '';
            $raw = $auction->get->laundry_features ?? null;
            $this->laundry_features = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            $this->other_laundry_features = $auction->get->other_laundry_features ?? '';
            $raw = $auction->get->floor_covering ?? null;
            $this->floor_covering = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            $this->other_floor_covering = $auction->get->other_floor_covering ?? '';
            $raw = $auction->get->security_features ?? null;
            $this->security_features = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            ...
            $raw = $auction->get->road_surface_type ?? null;
            $this->road_surface_type = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            $this->other_road_surface_type = $auction->get->other_road_surface_type ?? '';
            $raw = $auction->get->electrical_service ?? null;
            $this->electrical_service = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            $this->other_electrical_service = $auction->get->other_electrical_service ?? '';
            $this->ceiling_height = $auction->get->ceiling_height ?? '';
            $raw = $auction->get->building_features ?? null;
            $this->building_features = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            ...
            $raw = $auction->get->space_type ?? null;
            $this->space_type = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            $this->other_space_type = $auction->get->other_space_type ?? '';
            $raw = $auction->get->space_classification ?? null;
            $this->space_classification = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            ...
            $raw = $auction->get->association_fee_includes ?? null;
            $this->association_fee_includes = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            $this->association_fee_includes_other = $auction->get->association_fee_includes_other ?? '';
            $raw = $auction->get->association_amenities ?? null;
            $this->association_amenities = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            ...
            $raw = $auction->get->additional_documents ?? null;
            $this->additional_documents = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            ...
            $this->custom_services = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            ...
            $this->fees = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
            $raw = $auction->get->enable ?? null;
            $this->enable = is_string($raw) ? json_decode($raw, true) ?? [] : ($raw ? (array)$raw : []);
    ...
    protected function saveAllMetadata($auction)
    {
        ...
        $auction->saveMeta('heating_fuel', json_encode($this->heating_fuel));
        ...
        $auction->saveMeta('property_utilities', json_encode($this->property_utilities));
        $auction->saveMeta('other_property_utilities', $this->other_property_utilities);
        $auction->saveMeta('laundry_features', json_encode($this->laundry_features));
        $auction->saveMeta('other_laundry_features', $this->other_laundry_features);
        $auction->saveMeta('floor_covering', json_encode($this->floor_covering));
        $auction->saveMeta('other_floor_covering', $this->other_floor_covering);
        $auction->saveMeta('security_features', json_encode($this->security_features));
        ...
        $auction->saveMeta('space_type', json_encode($this->space_type));
        $auction->saveMeta('other_space_type', $this->other_space_type);
        $auction->saveMeta('space_classification', json_encode($this->space_classification));
     ...
     * client syncInput updates are applied. Mirrors hydrate()'s `auctionId ?: listingId`. Fails
     * closed with 403.
     */
    private function resolveOwnedMediaListing(): ?HirelandLordAgentAuction
    {
        ...
        $auction = HirelandLordAgentAuction::where('id', $id)
            ->where('user_id', Auth::id())
            ->first();
    ...
    {
        // S6 — ownership at the ACTION boundary, through the same resolver the delete path uses.
        // The old `$this->auctionId ?? $this->listingId` was a THIRD spelling of the target id,
        // differing from hydrate()'s `?:` on an empty-string auctionId; one resolver removes that.
        $auction = $this->resolveOwnedMediaListing();
