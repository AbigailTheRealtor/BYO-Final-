    ...
    public static function sections(): array
    {
        return [
            ...
            'Business Details' => [
                ...
                'SDE / EBITDA'                    => 'sde_ebitda',
                'Inventory Value'                 => 'inventory_value',
                'FF&E Value'                      => 'ffe_value',
                'Reason for Sale'                 => 'reason_for_sale',
                'Number of Employees'             => 'employee_count',
                'Financial Statements Available'  => 'financial_statements_available',
                'Tax Returns Available'           => 'tax_returns_available',
                'NDA Required'                    => 'nda_required',
                'Business Location Leased'        => 'business_location_leased',
                'Business Lease Monthly Rent'     => 'business_lease_monthly_rent',
                'Business Lease Expiration'       => 'business_lease_expiration',
                'Business Lease Renewal Options'  => 'business_lease_renewal_options',
                'Business Lease Assignable'       => 'business_lease_assignable',
                'Business Lease Additional Terms' => 'business_lease_additional_terms',
                'Licenses Required'               => 'licenses',
                'Sale Includes'                   => 'sale_includes',
                'Current Use'                     => 'current_use',
                'Building Features'               => 'building_features',
                'Road Frontage'                   => 'road_frontage',
                'Electrical Service'              => 'electrical_service',
