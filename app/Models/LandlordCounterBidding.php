...
class LandlordCounterBidding extends Model
{
    use HasFactory;

    protected $table = 'landlord_counter_bidding';

    protected $fillable = [
        'user_id',
        'landlord_agent_auction_id',
        'landlord_agent_auction_bid_id',
        'property_type',
        'parent_counter_id',
    ];
    ...
    public function bid()
    {
        return $this->belongsTo(LandlordAgentAuctionBid::class, 'landlord_agent_auction_bid_id');
    }
    ...
    {
        return $this->hasMany(LandlordCounterBiddingMeta::class, 'counter_bidding_id');
    }
