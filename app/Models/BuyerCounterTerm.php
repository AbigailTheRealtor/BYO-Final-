...
class BuyerCounterTerm extends Model
{
    use HasFactory;
    protected $appends = ["get"];

    protected $table = 'buyer_counter_terms';
    protected $guarded  = [];
    ...
    public function meta()
    {
        ...
        return $this->hasMany(BuyerCounterTermMeta::class, 'counter_term_id', 'id');
    }
    ...
    {
        $data = [];
        $metas = BuyerCounterTermMeta::where('counter_term_id', $this->id)->get();
