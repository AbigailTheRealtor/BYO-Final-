...
class BuyerAgentHiredNotification extends Notification implements ShouldBroadcast
{
    use Queueable;
    ...
    public function __construct($bid, $auction, $summaryId = null, $auctionType = 'buyer_agent')
    {
        $this->bid       = $bid;
