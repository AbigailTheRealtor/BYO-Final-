...
class AskAiContextBuilderService
{
    ...
    public const CANONICAL_SOURCE_MAP = [
        ...
        'seller' => [
            ...
            //
            // There is no actual-NOI source field on the listing, and — corrected in P0.1 —
            // there is no answerable KB question for it either: NOI questions route to
            // 'faq_answers.annual_net_operating_income', which is declared in
            // AskAiFieldQuestionRegistryService but has NO entry in config/ai_faq_seller.php,
            // so no seller can author it and no row can exist. The current, intended
            // behaviour is therefore that the assistant does not supply an NOI at all.
            // Whether to add that KB question is D3 triage work.
            //
            // Do not re-add a listing alias. If we do not hold a verified actual figure, the
            // system must not provide one.
            ...
            // must never be represented as the property's actual figure.
            //
            // P0.1 correction: cap-rate questions route to 'faq_answers.current_cap_rate',
            // which is likewise declared in the question registry but absent from
            // config/ai_faq_seller.php — so it is not currently seller-answerable and
            // resolves to "information not provided". That is the correct behaviour while we
            // hold no verified actual cap rate; adding the KB question is a D3 decision.
            ...
            // Facts the public seller page prints that no context key read. Lending and
            // deposit terms are deliberately NOT here (see AskAiPageFactDisposition).
            ...
            'included_personal_property'         => 'included_personal_property',
            'excluded_items'                     => 'excluded_items',
            'pet_types_allowed'                  => 'type_of_pets',
            'occupied_until'                     => 'occupant_tenant',
            'association_type'                   => ['association_type', 'association_type_other'],
            'association_approval_process'       => 'association_approval_process',
            'association_application_fee'        => 'association_application_fee',
            ...
            'min_lease_period'                   => ['min_lease_period', 'min_lease_period_other'],
            'hoa_condo_association_terms'        => 'hoa_condo_association_terms',
            'business_assets_other'              => 'assets_other',
            'real_estate_purchase'               => 'real_estate_purchase',
            'additional_seller_sale_terms'       => 'additional_seller_sale_terms',
            'sale_provision_assignment'          => 'sale_provision_assignment',
            'assignment_fee'                     => 'assignment_fee_amount',
            'assignment_fee_type'                => 'assignment_fee_type',
            'inspection_contingency_preference'  => 'inspection_contingency_preference',
            'preferred_inspection_period'        => 'preferred_inspection_period',
            'appraisal_contingency_preference'   => 'appraisal_contingency_preference',
            'appraisal_contingency_period'       => 'appraisal_contingency_period',
            'financing_contingency_preference'   => 'financing_contingency_preference',
            'financing_contingency_period'       => 'financing_contingency_period',
            'sale_of_buyer_property_contingency' => 'sale_of_buyer_property_contingency',
            'sale_of_buyer_property_period'      => 'sale_of_buyer_property_period',
            'escrow_agent_preference'            => 'escrow_agent_preference',
            'possession_preference'              => 'possession_preference',
            'possession_details'                 => 'possession_details',
            'home_warranty_details'              => 'home_warranty_amount_details',
            'exchange_item'                      => ['exchange_item', 'other_exchange_item'],
            'exchange_item_value'                => 'exchange_item_value',
            'exchange_item_condition'            => 'exchange_item_condition',
            'exchange_additional_cash'           => 'additional_cash',
            'value_determination'                => 'value_determination',
            'exchange_transfer_method'           => 'exchange_transfer_method',
            'exchange_liens_disclosure'          => 'exchange_liens_disclosure',
            'exchange_liens_details'             => 'exchange_liens_details',
            'exchange_inspection_rights'         => 'exchange_inspection_rights',
            'cryptocurrency_type'                => 'cryptocurrency_type',
            'crypto_percentage'                  => 'crypto_percentage',
            'cash_percentage_crypto'             => 'cash_percentage_crypto',
            'crypto_exchange_method'             => 'crypto_exchange_method',
            'crypto_custodian_wallet'            => 'crypto_custodian_wallet',
            'crypto_transaction_fees'            => 'crypto_transaction_fees',
            'crypto_transfer_timing'             => ['crypto_transfer_timing', 'crypto_transfer_timing_other'],
            'nft_description'                    => 'nft_description',
            'nft_percentage'                     => 'nft_percentage',
            'cash_percentage_nft'                => 'cash_percentage_nft',
            'nft_valuation_method'               => 'nft_valuation_method',
            'nft_transfer_method'                => 'nft_transfer_method',
            'nft_gas_fees'                       => 'nft_gas_fees',
            'lease_option_price'                 => 'lease_option_price',
            'lease_option_payment'               => 'lease_option_payment',
            'lease_option_duration'              => 'lease_option_duration',
            'option_fee_offered'                 => 'has_option_fee',
            'option_fee_amount'                  => 'option_fee_amount',
            'lease_option_fee_credit'            => 'lease_option_fee_credit',
            'lease_option_fee_credit_percentage' => 'lease_option_fee_credit_percentage',
            'lease_option_conditions'            => 'lease_option_conditions',
            'lease_option_terms'                 => 'lease_option_terms',
            'lease_option_maintenance'           => 'lease_option_maintenance',
            'lease_option_extension_terms'       => 'lease_option_extension_terms',
            'lease_purchase_price'               => 'lease_purchase_price',
            'lease_purchase_payment'             => 'lease_purchase_payment',
            'lease_purchase_duration'            => 'lease_purchase_duration',
            'lease_purchase_rent_credit'         => 'lease_purchase_rent_credit',
            'lease_purchase_rent_credit_amount'  => 'lease_purchase_rent_credit_amount',
            'lease_purchase_conditions'          => 'lease_purchase_conditions',
            'lease_purchase_terms'               => 'lease_purchase_terms',
            'lease_purchase_maintenance'         => 'lease_purchase_maintenance',
            'lease_purchase_extension_terms'     => 'lease_purchase_extension_terms',
        ...
        'landlord' => [
            ...
            // ── Universal coverage audit (2026-09-24) ─────────────────────────
            // Facts the public landlord page prints that no context key read. Each is a
            // property or lease-on-offer fact; see SnapshotFactVisibility for the tier.
            'association_type'                    => ['association_type', 'association_type_other'],
            'association_approval_required'       => 'association_approval_required',
            'association_approval_process'        => 'association_approval_process',
            'association_application_fee'         => 'association_application_fee',
            'owner_pays'                          => 'owner_pays',
            'common_areas_cleaning'               => 'common_areas_cleaning',
            'leasing_space'                       => ['leasing_space', 'leasing_spaces'],
            'occupant_status'                     => 'occupant_status',
            'occupied_until'                      => 'occupant_tenant',
            'restrictions'                        => 'restrictions',
            'minimum_leaseable'                   => 'minimum_leaseable',
            'garage_parking_features'             => 'garage_parking_spaces_option',
            'furnishings'                         => 'tenant_require',
            'included_storage_space_res_both'     => 'included_storage_space_res_both',
            'storage_space_res_both'              => 'storage_space_res_both',
            'included_storage_space_res_single'   => 'included_storage_space_res_single',
            'storage_space_res_single'            => 'storage_space_res_single',
            'included_storage_space_com_entire'   => 'included_storage_space_com_entire',
            'storage_space_com_entire'            => 'storage_space_com_entire',
            'included_storage_space_com_single'   => 'included_storage_space_com_single',
            'storage_space_com_single'            => 'storage_space_com_single',
            'pets_allowed_count'                  => 'number_of_pets',
            'pet_types_allowed'                   => 'type_of_pets',
            'pet_weight_limit'                    => ['weight_of_pets', 'pet_max_weight_lbs'],
        ],
