...
class LandlordSnapshotBuilder
{
    ...
    {
        $context = $this->contextBuilder->buildForListing('landlord', $listingId);

        $listing    = $context['listing']    ?? [];
        $faqAnswers = $context['faq_answers'] ?? [];

        $this->persistFacts($snapshot, $listing);
        $this->persistQuestions($snapshot, 'landlord');
