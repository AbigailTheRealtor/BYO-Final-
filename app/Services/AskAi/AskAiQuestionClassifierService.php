...
class AskAiQuestionClassifierService
{
    ...
    private const KEYWORD_RULES = [
        ...
        'listing_facts' => [
            ...
            'how will this buyer finance',
            'buyer loan type',
            'what financing type',
            // Lease requirements (tenant criteria)
            'lease requirements',
            ...
            // Pet species / weight (landlord Phase 2)
            'pet species',
            ...
            'pet weight',
            'max pet weight',
            // Leasing restrictions (landlord Phase 2)
            'leasing restrictions',
            'are there leasing restrictions',
            'lease restrictions on',
            ...
            'smoking allowed',
            'is smoking allowed',
            // Tenant smoking preference (Phase 2)
            ...
            // ---- Applicant requirements (landlord) ----------------------------
            'credit score flexibility',
            'is the landlord flexible on credit',
            'criminal background check required',
            'does the landlord require a background check',
            'is a background check required',
            'employment verification required',
            'does the landlord verify employment',
            'income verification required',
            'does the landlord verify income',
            'minimum income requirement',
            'what is the minimum income to qualify',
            // ---- Buyer / tenant 55+ and commute --------------------------------
            '55+ community preference',
            'is the buyer looking for 55 plus',
            'active adult community',
            'interested in 55 and older community',
            '55+ communit',
            '55 and over communit',
            'buyer looking at 55',
            'is the buyer looking at 55',
            'how does the buyer commute',
            'commute mode',
            'mode of transportation for commute',
            'buyer commute method',
            'commute destination zip',
            'commute destination for the buyer',
            'where does the buyer commute',
            'buyer commute destination',
            'how far is the buyer willing to commute',
            'maximum commute time',
            'max commute time',
            'buyer commute limit',
            'commute time the buyer',
            // ---- Buyer purchase purpose (Phase 2) ---------------------------
            ...
            'purchase purpose',
            // ---- Buyer non-negotiable amenities (Phase 2) -------------------
            ...
            // ---- Commercial space type and details ----------------------------
            'commercial space type',
            'type of commercial space',
            'space classification for this listing',
            'class of office space',
            'shared amenities in the building',
            'what shared amenities are available',
            'building shared amenities',
            'number of restrooms in the space',
            'how many restrooms does the space have',
            'office and retail square footage',
            'office square footage breakdown',
            ...
            // Tenant renewal preference (Phase 2)
            'lease renewal option',
            'does the tenant want a lease renewal',
            'tenant renewal option',
            'tenant wants a renewal',
            // Rental restrictions
            ...
            // ---- Phase 2 gap coverage: Seller Tax / Legal / Parcel --------------
            // These fields are in LISTING_KEY_KEYWORD_MAP but classified as
            // 'unsupported' without entries here, blocking Guard B from firing.
            'parcel id',
            ...
            'is association approval',
            'special assessment',
            'are there special assessments',
            'special assessments on this',
            'tax year',
            'property tax year',
            'what tax year',
            // ---- Phase 2 gap coverage: Accessibility / Commercial Lease --------
            'accessibility requirements',
            'accessibility needs',
            'any accessibility',
            'ada accommodations',
            'commercial lease type',
            'lease type preference',
            // ---- Phase 2 gap coverage: Tenant move-in date range ---------------
            // Distinct phrases from generic "move-in date" (buyer_tenant_match)
            // so tenant criteria earliest/latest move-in date routes here.
