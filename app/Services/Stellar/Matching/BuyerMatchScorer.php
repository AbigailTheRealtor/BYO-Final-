...
class BuyerMatchScorer
{
    ...
    {
        $facts = BridgeListingMatchFactsBuilder::build($listing);
    ...
    public function scoreFacts(ListingMatchFacts $facts, BuyerCriteriaPayload $criteria): ListingMatchScore
    {
        ...
        $amenityScore         = $this->scoreAmenities($facts, $criteria);
        ...
        return new ListingMatchScore($total, $categoryScores, $importantPlaceMatches);
    }
    ...
    private function scoreAmenities(ListingMatchFacts $facts, BuyerCriteriaPayload $criteria): array
    {
        $expressed = [];
