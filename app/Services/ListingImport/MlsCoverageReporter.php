...
class MlsCoverageReporter
{
    ...
    private static function fieldInventory(): array
    {
        ...
        $merge(
            ...
            [
                // Vacant Land specific — no canonical key (not present in vacant_land.txt fixture;
                // no parser branch added per task rule: only fixture-backed fields get branches)
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Current Use',              'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Current Adjacent Use',     'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Road Frontage',            'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Road Surface Type',        'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Fences',                  'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Vegetation',              'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Buildable',               'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Easements',               'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Front Footage',           'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Number of Wells',         'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Number of Septics',       'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Water Available to Site', 'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Sewer Available to Site', 'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Electric Available',      'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Gas Available',           'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Telecom / Internet Available', 'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Lot Features',            'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — cleared/filled/wooded; not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Utilities Available',     'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — water/sewer/electric (generic); not in fixture; no parser branch'],
                ['form' => 'Vacant Land', 'section' => 'PROPERTY DETAILS', 'mls_label' => 'Topography',              'canonical_key' => null, 'norm_required' => false, 'notes' => 'VL field — not in fixture; no parser branch'],
                // Directions intentionally excluded from seller map — no supported destination field
                ['form' => 'Vacant Land', 'section' => 'REMARKS',          'mls_label' => 'Directions',              'canonical_key' => 'directions', 'norm_required' => false, 'notes' => 'Parsed; intentionally excluded from all role maps — no public-facing destination field'],
            ],
