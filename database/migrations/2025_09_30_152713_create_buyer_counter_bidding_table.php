...
class CreateBuyerCounterBiddingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('buyer_counter_bidding', function (Blueprint $table) {
            $table->id();

            // Main fields stored directly in the table
            $table->unsignedBigInteger('user_id');
            $table->unsignedBigInteger('buyer_agent_auction_id');
            $table->unsignedBigInteger('buyer_agent_auction_bid_id');
            ...
            $table->foreign('buyer_agent_auction_bid_id')->references('id')->on('buyer_agent_auction_bids')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('buyer_counter_bidding');
    }
}
